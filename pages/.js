        ...
        if (
          ...
          if (
            ...
            var html =
              ...
              '<div class="progress" style="height: 6px;width: 170px;border-radius: 15px;background: #d9534f;"><div class="progress-bar progress-bar-success progressGreen" role="progressbar" style="width:64%;background: #4CAF50;height: 100%;border-radius: 25px;"></div></div></div><div id="failUserAppend"></div></div>' +
              ...
              '<div style="width: 10%;padding: 2.7% 1%;float:left;margin-left: -85px;"><button type="button" id="showSummery" uid="' +
              AllCloudsInfo[i].id +
              '" style="display: inline-block;background-color: #1220f6;color: #fff;border: none;border-radius: 3px;z-index: 999999;width:91px;" onclick="showPremigDivAlna(this)">Quick Scan</button></div>' +
              '<div style="width: 8%;padding: 2.7% 1%;float:left;margin-left: -16px;"><a href="https://staging.cloudfuze.com/pages/teammigration.html?ver=1028"><button type="button" id="showSummery" style="display: inline-block;background-color: #1220f6;color: #fff;border: none;border-radius: 3px;z-index: 999999;width: 64px;">Migrate</button></a></div>' +
              '<div id="mngCloudType" style="width: 6%;padding: 2.7% 1%;float:left;"><span>userType</span></div>' +
              ...
              '" name="' +
              AllCloudsInfo[i].cloudName +
              '"class="getCloudsInfo" style="width: 4%;padding: 2.7% 1%;float:left;text-align:center;cursor:pointer;"><i class="lnil lnil-chevron-down-circle" style="color: #0062FF;font-size: 20px;font-weight:600;"></i></div><hr id="manageInfoHr" style="margin-top: 8%;width: 96%;display:none">' +
            ...
            if (
              ...
              if (
                ...
                var html =
                  ...
                  prvsnWidth +
                  '%;background: #4CAF50;height: 100%;border-radius: 25px;"></div></div></div><div id="failUserAppend"></div></div>' +
                  '<div id="mngCloudSync" style="width: 3%;padding: 2.7% 3.8% 0% 0%;float:left;"><i class="lnir lnir-spinner-arrow" id="reAuthorizeCld" title="Reauthenticate users" style="font-size: 15px;font-weight:600;"></i><img src="../img/retry.gif" id="AuthorizeCld" title="Authenticating users"  style="margin-left: 61%;height: 20px;width: 20px;cursor: pointer;margin-top: 12%;display: none"/></div>' +
                  '<div id="mngCloudEmail" style="width: 28%;padding: 2.7% 1%;float:left;"><span title="titleEmail">emailId</span></div>' +
                  '<div style="width: 10%;padding: 2.7% 1%;float:left;margin-left: -85px;"><button type="button" id="showSummery" uid="' +
                  AllCloudsInfo[i].id +
                  ...
                  '" name="' +
                  AllCloudsInfo[i].cloudName +
                  '"class="getCloudsInfo" style="width: 4%;padding: 2.7% 1%;float:left;text-align:center;cursor:pointer;"><i class="lnil lnil-chevron-down-circle" style="color: #0062FF;font-size: 20px;font-weight:600;cursor:pointer;"></i></div><hr id="manageInfoHr" style="margin-top: 8%;width: 96%;display:none">' +
                  '<div class="appendcloudDetails" style="width: 96%;margin: 2%;border-radius: 5px;display:none"></div></div>';
              } else {
                var html =
                  '<div class="cloudsinfo" id="cloudInfo" style="background: #FCFCFC 0% 0% no-repeat padding-box;border: 1px solid #E5E5E5;border-radius: 5px;height:80px;width:100%;margin-bottom: 2%;">' +
                  ...
                  totalCount +
                  " Users </p>" +
                  '<div class="progress" style="height: 6px;width: 170px;border-radius: 15px;background: #d9534f;"><div class="progress-bar progress-bar-success progressGreen" role="progressbar" style="width:100%;background: #4CAF50;height: 100%;border-radius: 25px;"></div></div></div><div id="failUserAppend"></div></div>' +
                  '<div id="mngCloudSync" style="width: 3%;padding: 2.7% 3.8% 0% 0%;float:left;"><i class="lnir lnir-spinner-arrow" id="reAuthorizeCld" title="Reauthenticate users" style="font-size: 15px;font-weight:600;"></i><img src="../img/retry.gif" id="AuthorizeCld" title="Authenticating users"  style="margin-left: 61%;height: 20px;width: 20px;cursor: pointer;margin-top: 12%;display: none"/></div>' +
                  '<div id="mngCloudEmail" style="width: 28%;padding: 2.7% 1%;float:left;"><span title="titleEmail">emailId</span></div>' +
                  '<div style="width: 10%;padding: 2.7% 1%;float:left;margin-left: -85px;"><button type="button" id="showSummery" uid="' +
                  AllCloudsInfo[i].id +
        ...
        if (AllCloudsInfo[i].userType === "ADMIN") {
          ...
          if (
            ...
            if (AllCloudsInfo[i].cloudName === "BOX_BUSINESS") {
              var multi_html =
                '<div class="table-responsive box" id="cloudDetails" style="background: white;border: 1px solid #e5e5e5;border-radius: 5px;font-size:12px;overflow-x:hidden;"><table class="table table-condensed" style="font-size: 14px;margin-bottom:0;"><tbody><tr style="height: 5vh;border: 2px solid #FFFFFF"><td class="innerPlus" style="width: 15%;padding: 0.35rem 0.5rem;"  id="' +
                CldId +
                '"><div><a class="failedUsers" href="#" style="color:#FF4C4C;text-decoration:underline;font-weight:bold;font-size:12px;opacity:0.4;pointer-events:none;">Failed Users Details</a></div></td></tr><tr style="height: 5vh;border: 2px solid #FFFFFF"><td style="width: 35%;padding: 0.35rem 0.5rem;"></tr><tr class="appendUsersList" style="display: none"></tr></tbody></table></div>';
            } else {
              var multi_html =
                '<div class="table-responsive box" id="cloudDetails" style="background: white;border: 1px solid #e5e5e5;border-radius: 5px;font-size:12px;overflow-x:hidden;"><table class="table table-condensed" style="font-size: 14px;margin-bottom:0;"><tbody><tr style="height: 5vh;border: 2px solid #FFFFFF"><td rowspan="2" class="innerPlus" style="width: 15%;padding: 0.35rem 0.5rem;"  id="' +
                CldId +
                '"><div><a class="failedUsers" href="#" style="color:#FF4C4C;text-decoration:underline;font-weight:bold;font-size:12px;opacity:0.4;pointer-events:none;">Failed Users Details</a></div></td></tr><tr style="height: 5vh;border: 2px solid #FFFFFF"><td style="width: 35%;padding: 0.35rem 0.5rem;"></tr><tr class="appendUsersList" style="display: none"></tr></tbody></table></div>';
            }
          } else {
            if (AllCloudsInfo[i].cloudName === "BOX_BUSINESS") {
              var multi_html =
                '<div class="table-responsive box" id="cloudDetails" style="background: white;border: 1px solid #e5e5e5;border-radius: 5px;font-size:12px;overflow-x:hidden;"><table class="table table-condensed" style="font-size: 14px;margin-bottom:0;"><tbody><tr style="height: 5vh;border: 2px solid #FFFFFF"><td class="innerPlus" style="width: 15%;padding: 0.35rem 0.5rem;"  id="' +
                CldId +
                '"><div><a class="failedUsers" href="#" style="color:#FF4C4C;text-decoration:underline;font-weight:bold;font-size:12px;opacity:0.4;pointer-events:none;">Failed Users Details</a></div></td></tr><tr style="height: 5vh;border: 2px solid #FFFFFF"><td style="width: 35%;padding: 0.35rem 0.5rem;"><td style="width: 15%;color:#0062ff;"  id="' +
                CldId +
                '"></tr><tr class="appendUsersList" style="display: none"></tr></tbody></table></div>';
            } else {
              var multi_html =
                '<div class="table-responsive box" id="cloudDetails" style="background: white;border: 1px solid #e5e5e5;border-radius: 5px;font-size:12px;overflow-x:hidden;"><table class="table table-condensed" style="font-size: 14px;margin-bottom:0;"><tbody><tr style="height: 5vh;border: 2px solid #FFFFFF"><td rowspan="2" class="innerPlus" style="width: 15%;padding: 0.35rem 0.5rem;"  id="' +
                CldId +
                '"><div><a class="failedUsers" href="#" style="color:#FF4C4C;text-decoration:underline;font-size:12px;font-weight:bold;">Failed Users Details</a></div></td></tr><tr style="height: 5vh;border: 2px solid #FFFFFF"></tr><tr class="appendUsersList" style="display: none"></tr></tbody></table></div>';
            }
          }
          // $('#failUserAppend').append('multi_html')
...
function showPremigDivAlna(e) {
  ...
  } // console.log("click", $($parentTr).attr("id"));
  // $("#openModel").css({
  //   transform: "scale(1)",
