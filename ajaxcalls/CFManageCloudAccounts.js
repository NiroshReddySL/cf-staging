...
var CFManageCloudAccountsAjaxCall = {
  ...
  getAllClouds: function (src, dstn, page) {
    if (
      localStorage.UserId === "60119846e4b089b81ae653ff0" ||
      localStorage.testing === "true"
    ) {
      var apiUrl = `http://localhost:8001/clouds`;
    } else {
    ...
    $.ajax({
      ...
      success: function (AllClouds) {
        makeSeperateCloudList(AllClouds);
          ...
          for (j = 0; j < AllCloudsInfo.length; j++) {
            if (AllCloudsInfo[j].id === cldId) {
              if (
                ...
                AllCloudsInfo[i].cloudName === "SHAREFILE_BUSINESS" ||
  ...
  getAllCloudTitlesSettings: function (CloudName, CloudId) {
    ...
    for (var i = 0; i < CloudName.length; i++) {
        ...
        if (
          ...
          if (
            ...
            var html =
              ...
              '<div id="mngCloudName" style="width: 22%;height: 100%;float: left;color: #1F2129;font-weight: 500;display: flex;flex-direction: column;justify-content: center;"><span>' +
              CLName[CloudName[i]] +
              "</span></div>" +
              '<div id="mngCloudData" style="width: 20%;padding: 2% 1%;float:left;">' +
              '<div style="width: 100%;" id="incrementProgress"><p id="usersDisplay" class="userCount' +
              AllCloudsInfo[i].id +
              '" style="color: #707070;font-size: 12px;width: 135px;float: left;margin-bottom: 2%;">0 out of 0 Users </p><span id="percentOfUsers" style="font-size: 12px;font-weight: 600;float: left;color: #000;">0%</span>' +
              ...
              '<div id="mngCloudEmail" style="width: 28%;height: 100%;float: left;color: #1F2129;font-weight: 500;display: flex;flex-direction: column;justify-content: center;"><span title="titleEmail">emailId</span>rollTags</div>' +
              '<div id="mngCloudType" style="width: 8%;padding: 2.7% 1%;float:left;"><span>userType</span></div>' +
              '<div id="mngCloudRemove" style="width: 6%;padding: 2.7% 2%;float:left;text-align: right;"><i cldId="' +
              AllCloudsInfo[i].id +
              '" id="delCld" cloudName="' +
              AllCloudsInfo[i].cloudName +
            ...
            if (
              ...
              if (
                ...
                var html =
                  ...
                  '<div style="width: 100%;" id="incrementProgress"><p id="usersDisplay" class="userCount' +
                  AllCloudsInfo[i].id +
                  '" style="color: #707070;font-size: 12px;width: 135px;float: left;margin-bottom: 2%;">' +
                  prvsnLen +
                  " out of " +
                  totalCount +
                  ' Users </p><span id="percentOfUsers" style="font-size: 12px;font-weight: 600;float: left;color: #000;">100%</span>' +
                  ...
                  prvsnWidth +
                  '%;background: #4CAF50;height: 100%;border-radius: 25px;"></div></div></div></div>' +
                  '<div id="mngCloudSync" style="width: 3%;padding: 2.7% 3.8% 0% 0%;float:left;"><i class="lnir lnir-spinner-arrow" id="reAuthorizeCld" title="Reauthenticate users" style="font-size: 15px;font-weight:600;"></i><img src="../img/retry.gif" id="AuthorizeCld" title="Authenticating users"  style="margin-left: 61%;height: 20px;width: 20px;cursor: pointer;margin-top: 12%;display: none"/></div>' +
                  '<div id="mngCloudEmail" style="width: 28%;height: 100%;float: left;color: #1F2129;font-weight: 500;display: flex;flex-direction: column;justify-content: center;"><span title="titleEmail">emailId</span>rollTags</div>' +
                  '<div id="mngCloudType" style="width: 8%;padding: 2.7% 1%;float:left;"><span>userType</span></div>' +
                  '<div id="mngCloudRemove" style="width: 6%;padding: 2.7% 2%;float:left;text-align: right;"><i cldId="' +
                ...
                var html =
                  ...
                  '<div style="width: 100%;" id="incrementProgress"><p id="usersDisplay" class="userCount' +
                  AllCloudsInfo[i].id +
                  '" style="color: #707070;font-size: 12px;width: 135px;float: left;margin-bottom: 2% 1%;">' +
                  totalCount +
                  " out of " +
                  totalCount +
                  ' Users </p><span id="percentOfUsers" style="font-size: 12px;font-weight: 600;float: left;color: #000;">100%</span>' +
              ...
              var html =
                '<div class="cloudsinfo" id="cloudInfo" style="background: #FCFCFC 0% 0% no-repeat padding-box;border: 1px solid #E5E5E5;border-radius: 5px;height:80px;width:100%;margin-bottom: 2%;">' +
                '<div id="mngCloudIcon" style="width: 7%;padding: 1.5% 1%;float:left;text-align:center;padding-top: 1%;"><div class="bg-cfIcon"></div></div>' +
                '<div id="mngCloudName" style="width: 20%;height: 100%;float: left;color: #1F2129;font-weight: 500;display: flex;flex-direction: column;justify-content: center;"><span>' +
                CLName[CloudName[i]] +
                "</span></div>" +
                ...
                " out of " +
                totalCount +
                ' Users </p><span id="percentOfUsers" style="font-size: 12px;font-weight: 600;float: left;color: #000;">0%</span>' +
                '<div class="progress" style="height: 6px;width: 170px;border-radius: 15px;background: #d9534f;"><div class="progress-bar progress-bar-success progressGreen" role="progressbar" style="width:' +
                _prvsnWidth +
                '%;background: #4CAF50;height: 100%;border-radius: 25px;"></div></div></div></div>' +
                '<div id="mngCloudSync" style="width: 3%;padding: 2.7% 3.8% 0% 0%;float:left;"><i class="lnir lnir-spinner-arrow" id="reAuthorizeCld" title="Reauthenticate users" style="font-size: 15px;font-weight:600;"></i><img src="../img/retry.gif" id="AuthorizeCld" title="Authenticating users"  style="margin-left: 61%;height: 20px;width: 20px;cursor: pointer;margin-top: 12%;display: none"/></div>' +
          ...
          var html =
            '<div class="cloudsinfo" id="cloudInfo" style="background: #FCFCFC 0% 0% no-repeat padding-box;border: 1px solid #E5E5E5;border-radius: 5px;height:80px;width:100%;margin-bottom: 2%;">' +
            '<div id="mngCloudIcon" style="width: 7%;padding: 1.5% 1%;float:left;text-align:center;padding-top: 1%;"><div class="bg-cfIcon"></div></div>' +
            '<div id="mngCloudName" style="width: 46%;height: 100%;float: left;color: #1F2129;font-weight: 500;display: flex;flex-direction: column;justify-content: center;"><span>' +
            CLName[CloudName[i]] +
            "</span></div>" +
            '<div id="mngCloudEmail" style="width: 28%;height: 100%;float: left;color: #1F2129;font-weight: 500;display: flex;flex-direction: column;justify-content: center;"><span title="titleEmail">emailId</span>rollTags</div>' +
            '<div id="mngCloudType" style="width: 8%;padding: 2.7% 1%;float:left;"><span>userType</span></div>' +
      ...
      if (AllCloudsInfo[i].role) {
        html = html.replace(
          "rollTags",
          `<span style="font-size: 12px;padding: 0px 5px;background: #f2f3ff;border-radius: 4px;color: #0062ff;width: fit-content;font-weight: 400;">${AllCloudsInfo[i].role}</span>`
        );
      } else {
        html = html.replace("rollTags", "");
      }
      ...
      } else if (AllCloudsInfo[i].cloudName === "OUTLOOK") {
        var title = AllCloudsInfo[i].emailId;
        var email = CFManageCloudAccountsAjaxCall.getMaxChars(
          AllCloudsInfo[i].emailId,
          30
        );
      } else {
      ...
      if (
        AllCloudsInfo[i].cloudName === "MICROSOFT_TEAMS" &&
        JSON.parse(localStorage.CFUser).primaryEmail === "nagesh@cloudfuze.com"
      ) {
        $('[name="MICROSOFT_TEAMS"]').css("visibility", "hidden");
      }
      if (
        ...
        if (AllCloudsInfo[i].userType === "ADMIN") {
          ...
          if (
            ...
            if (AllCloudsInfo[i].cloudName === "BOX_BUSINESS") {
              ...
              var multi_html =
                '<div class="table-responsive box" id="cloudDetails" style="background: white;border: 1px solid #e5e5e5;border-radius: 5px;font-size:12px;overflow-x:hidden;"><table class="table table-condensed" style="font-size: 14px;margin-bottom:0;"><tbody><tr style="height: 5vh;border: 2px solid #FFFFFF"><td style="width: 35%;padding: 0.35rem 0.5rem;"><div style="width: 35%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Name</div><div style="width: 65%;float: right;font-size:12px;" title="dispName">displayName</div></td><td style="width: 20%;padding: 0.35rem 0.5rem;"><div style="width: 50%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Total Users</div><div style="width: 50%;float: right;font-size:12px;">totalUsers</div></td><td rowspan="2" style="width: 25%;padding: 0.35rem 0.5rem;"><div style="width: 100%;float: left;color:#FF4C4C;font-size:12px;"><span style="background: #FFF0F0 0% 0% no-repeat padding-box;border-radius: 4px;padding:4%;font-weight:bold;">Users Not Added</span><span style="background: #FFF0F0 0% 0% no-repeat padding-box;border-radius: 4px;padding: 4% 9%;margin-left: -2%;">notAddedUsers</span></div></td><td rowspan="2" class="innerPlus" style="width: 15%;padding: 0.35rem 0.5rem;"  id="' +
                CldId +
            ...
            if (AllCloudsInfo[i].cloudName === "BOX_BUSINESS") {
              var multi_html =
                '<div class="table-responsive box" id="cloudDetails" style="background: white;border: 1px solid #e5e5e5;border-radius: 5px;font-size:12px;overflow-x:hidden;"><table class="table table-condensed" style="font-size: 14px;margin-bottom:0;"><tbody><tr style="height: 5vh;border: 2px solid #FFFFFF"><td style="width: 35%;padding: 0.35rem 0.5rem;"><div style="width: 35%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Name</div><div style="width: 65%;float: right;font-size:12px;" title="dispName">displayName</div></td><td style="width: 20%;padding: 0.35rem 0.5rem;"><div style="width: 50%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Total Users</div><div style="width: 50%;float: right;font-size:12px;">totalUsers</div></td><td rowspan="2" style="width: 25%;padding: 0.35rem 0.5rem;"><div style="width: 100%;float: left;color:#FF4C4C;font-size:12px;"><span style="background: #FFF0F0 0% 0% no-repeat padding-box;border-radius: 4px;padding:4%;font-weight:bold;">Users Not Added</span><span style="background: #FFF0F0 0% 0% no-repeat padding-box;border-radius: 4px;padding: 4% 9%;margin-left: -2%;">notAddedUsers</span></div></td><td class="innerPlus" style="width: 15%;padding: 0.35rem 0.5rem;"  id="' +
                CldId +
                '"><div><a class="failedUsers" href="#" style="color:#FF4C4C;text-decoration:underline;font-weight:bold;font-size:12px;">Failed Users Details</a></div></td></tr><tr style="height: 5vh;border: 2px solid #FFFFFF"><td style="width: 35%;padding: 0.35rem 0.5rem;"><div style="width: 35%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Domain Name</div><div style="width: 65%;float: right;font-size:12px;" title="nameofDomain">domainName</div></td><td style="width: 20%;padding: 0.35rem 0.5rem;"><div style="width: 50%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Added Users</div><div style="width: 50%;float: right;font-size:12px;">addedUsers</div></td><td style="width: 15%;color:#0062ff;"  id="' +
                CldId +
                '"><div id="userDataDtls" style="width: 65%;float: left;font-weight: bold;font-size:12px;">Users Data Size</div><div style="width:35%;float:right;"><a href="#" id="dataDtls" style="text-decoration: underline;"><i class="lnil lnil-download" style="font-weight:bold;"></i></a></div></td></tr><tr class="appendUsersList" style="display: none"></tr></tbody></table></div>';
            } else {
              var multi_html =
                '<div class="table-responsive box" id="cloudDetails" style="background: white;border: 1px solid #e5e5e5;border-radius: 5px;font-size:12px;overflow-x:hidden;"><table class="table table-condensed" style="font-size: 14px;margin-bottom:0;"><tbody><tr style="height: 5vh;border: 2px solid #FFFFFF"><td style="width: 35%;padding: 0.35rem 0.5rem;"><div style="width: 35%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Name</div><div style="width: 65%;float: right;font-size:12px;" title="dispName">displayName</div></td><td style="width: 20%;padding: 0.35rem 0.5rem;"><div style="width: 50%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Total Users</div><div style="width: 50%;float: right;font-size:12px;">totalUsers</div></td><td rowspan="2" style="width: 25%;padding: 0.35rem 0.5rem;"><div style="width: 100%;float: left;color:#FF4C4C;font-size:12px;"><span style="background: #FFF0F0 0% 0% no-repeat padding-box;border-radius: 4px;padding:4%;font-weight:bold;">Users Not Added</span><span style="background: #FFF0F0 0% 0% no-repeat padding-box;border-radius: 4px;padding: 4% 9%;margin-left: -2%;">notAddedUsers</span></div></td><td rowspan="2" class="innerPlus" style="width: 15%;padding: 0.35rem 0.5rem;"  id="' +
                CldId +
                '"><div><a class="failedUsers" href="#" style="color:#FF4C4C;text-decoration:underline;font-size:12px;font-weight:bold;">Failed Users Details</a></div></td></tr><tr style="height: 5vh;border: 2px solid #FFFFFF"><td style="width: 35%;padding: 0.35rem 0.5rem;"><div style="width: 35%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Domain Name</div><div style="width: 65%;float: right;font-size:12px;" title="nameofDomain">domainName</div></td><td style="width: 20%;padding: 0.35rem 0.5rem;"><div style="width: 50%;float: left;font-weight: bold;font-size:12px;color:#1f2129;">Added Users</div><div style="width: 50%;float: right;font-size:12px;">addedUsers</div></td></tr><tr class="appendUsersList" style="display: none"></tr></tbody></table></div>';
            }
          }
          ...
          if (AllCloudsInfo[i].loadLock === false) {
            var syncIcon =
                '<i class="lnil lnil-reload refresh-Cloud" id="refreshIcon" style="font-weight:600;"></i>',
        ...
        if (data.length !== 0) {
          ...
          for (var j = 0; j < data.length; j++) {
            ...
            appendHtml = _html
              .replace(
                "userName",
                CFManageCloudAccountsAjaxCall.getMaxChars(data[j].userEmail, 40)
              )
  ...
  fileFolderCount: function (a, _this) {
    if (_this == undefined) {
      ...
      _this.attr("srccldname") == "SHAREFILE_BUSINESS" &&
      ...
      var apiCall =
        ...
        a;
    } else if (localStorage.isFileFolderInfo === "true") {
      var apiCall =
        apicallurl +
  ...
  getAllMoveStatusForUser: function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (
          data.length == 30 &&
          $("#moveReportsForUser tr:visible").length < 30
        ) {
            ...
            if (moveCheckSum == "source" && PageNumber == 1) {
              ...
              $("#moveSource").append(
                '<div data-type="sourceback" style="width: 50%;cursor:pointer;height:30px;padding: 2%;margin-bottom: 2%;" name="' +
                  ...
                  '" cid="' +
                  SingleCloudId +
                  '"><i style="width:20%;float: left;display: block;font-size: 18px;margin-left: 10%;margin-top: 2%;margin-right: -9%;" class="lnil lnil-arrow-left-circle cf-back"></i><span>Back</span></div>'
              );
            }
            if (moveCheckSum == "dest" && PageNumber == 1) {
              $("#moveDestination").html("");
              ...
              $("#moveDestination").append(
                '<div data-type="destback" style="width: 100%;cursor:pointer;height:30px;padding: 2%;margin-bottom: 2%;" name="' +
                  ...
                  '" cid="' +
                  SingleCloudId +
                  '"><i style="width:20%;float: left;display: block;font-size: 18px;margin-left: 5%;margin-top: 0.5%;margin-right: -15%;" class="lnil lnil-arrow-left-circle cf-back"></i><span>Back</span></div>'
              );
              if (RootFoldersandFiles.length) {
                $("#move-header")
                  .find("#dynamicDestCloudName")
                  ...
                  if (SinglePId == 0) {
                    ...
                    $("#moveSource").append(
                      '<div data-type="sourceback" style="width: 50%;cursor:pointer;height:30px;padding: 2%;margin-bottom: 2%;" name="' +
                        ...
                        '" id="getClouds" cid="' +
                        SingleCloudId +
                        '"><i style="width:20%;float: left;display: block;font-size: 18px;margin-left: 10%;margin-top: 1%;margin-right: -9%;" class="lnil lnil-arrow-left-circle cf-back"></i><span>Back</span></div>'
                    );
                    CFManageCloudAccountsAjaxCall.getAllFileNames(
                      RootFoldersandFiles,
                      PageNumber
  ...
  deleteCloud: function (a, cloudName) {
    ...
    var _a = false;
    if (cloudName === "OUTLOOK" || cloudName === "GMAIL") {
      var apiUrl =
        apicallurl +
        "/users/" +
        CFManageCloudAccountsAjaxCall.getUserId() +
  ...
  if (
    ...
    if (
      ...
      if (!$(".jobsRow").find("i").hasClass("fa-chevron-circle-up")) {
        if ($("#move-header").attr("pgNO") !== "END") {
          mappingOptions.appendMigrationJobs(
            Number($("#move-header").attr("pgNO")) + 1,
            150
          );
        }
      }
...
$("#manageclouddiv").on("click", '[data-action="delete"]', function () {
  ...
  $("#CFCLDelete").attr("cloudname", $(this).attr("cloudname"));
...
$("#CFCLDelete").on("click", function () {
  ...
  var _r = CFManageCloudAccountsAjaxCall.deleteCloud(
    _id,
    $(this).attr("cloudname")
  );
...
$(document).on("click", ".refresh-Cloud", function () {
  $(this).removeClass("lnil lnil-reload").addClass("cloudSpinn");
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.reauthorization == true) {
        ...
        $(".userCount" + cldId).text(
          usersCount + " out of " + data.totolClouds + " Users"
        );
        _parent
          .find("#usersDisplay")
...
function makeSeperateCloudList(cloudList) {
  var personalCloudList = [];
  var businessCloudList = [];
  $.each(cloudList, function (i, cloudListObj) {
    cloudName = cloudListObj.cloudName;
    if (
      cloudName === "WASABI" ||
      cloudName === "ONEDRIVE" ||
      cloudName === "G_DRIVE" ||
      cloudName === "DROP_BOX" ||
      cloudName === "BOX" ||
      cloudName === "EGNYTE_STORAGE" ||
      cloudName === "SHAREPOINT_ONLINE_CONSUMER" ||
      cloudName === "SHARED_DRIVES" ||
      cloudName === "NTLM_STORAGE" ||
      cloudName === "FTP" ||
      cloudName === "ONEDRIVE_BUSINESS" ||
      cloudName === "SHAREPOINT_CONSUMER_HYBRID" ||
      cloudName === "AMAZON_GLACIER" ||
      (cloudName === "AMAZON" && cloudListObj.businessCloud === false)
    ) {
      if (cloudName === "AMAZON" && cloudListObj.businessCloud === false) {
        personalCloudList.push(
          cloudListObj.cloudUserId.split("|")[0] +
            "|" +
            cloudListObj.cloudUserId.split("|")[2]
        );
      } else {
        personalCloudList.push(cloudListObj.cloudUserId);
      }
    } else {
      if (cloudName === "SLACK") {
        businessCloudList.push(
          cloudListObj.cloudUserId.split("|")[0] +
            "|" +
            cloudListObj.cloudUserId.split("|")[1]
        );
      } else if (
        cloudName === "AMAZON" &&
        cloudListObj.businessCloud === true
      ) {
        businessCloudList.push(
          cloudListObj.cloudUserId.split("|")[0] +
            "|" +
        ...
        businessCloudList.push(cloudListObj.cloudUserId);
      }
    }
  });
  localStorage.setItem("personalCloudList", personalCloudList);
  localStorage.setItem("businessCloudList", businessCloudList);
}

$("#manageclouddiv").on("click", '[data-action="restricted"]', function () {
  $(".restrictedUser-Pannel").css("display", "flex");
});

$('[id="closeRestrictedUser"]').click(function () {
  $(".restrictedUser-Pannel").css("display", "none");
});

getUserNameIcon = () => {
  let name = JSON.parse(localStorage.CFUser).lastName;
  if (name === undefined) {
    return "-";
...
$("#newDashName").html(getUserNameIcon());

function checkNewCloudAdding() {
  $('[id="' + localStorage.addedAdminId + '"]')
    .find(".lnil-chevron-down-circle")
    .trigger("click");
  ...
  $("#clouds").animate(
    {
      scrollTop: $('[id="' + localStorage.addedAdminId + '"]')
        .parent()
        .offset().top,
    },
    1000
  ...
  <td colspan="4"><div
    ...
    <table
      ...
      style="font-size: 14px; border: 1px solid lightgray">
      <thead style="background: #0062ff; color: white; border-radius: 4px">
        <tr>
          <th
            style="
              font-weight: 500;
  ...
  $('[id="' + localStorage.addedAdminId + '"]')
    ...
    .find(".appendUsersList")
    .parent()
    .prepend(`<tr style="height: 5vh; border: 2px solid rgb(255, 255, 255);">
      <td style="text-align: center;font-size: 12px;font-weight:500;">Name: Testing</td>
      <td style="text-align: center;font-size: 12px;font-weight:500;">Email: admin@testing.com</td>
      <td style="text-align: center;font-size: 12px;font-weight:500;">Added Users: 0</td>
      <td style="text-align: center;font-size: 12px;font-weight:500;">Cloud Adding Status: In Progress</td>
    </tr>`);
  $('[id="' + localStorage.addedAdminId + '"]')
    .parent()
    .find(".appendUsersList")
