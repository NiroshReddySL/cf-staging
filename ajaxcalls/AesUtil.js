...
var passPhrase = "TokenEncryptionPhase";

getValidToken = function (userId,b) {
    if(b == undefined || b == null){
        b = userId;
    }
    var aesUtil = new AesUtil(keySize, iterationCount);
    var random = Math.floor(Math.random() * 32768);
    var nounceTime = (new Date).getTime() + 86400000;
    var arr1 = {
        'nounce': nounceTime,
        'userId': userId,
        'random': random,
    ...
    var encrypt = aesUtil.encrypt(salt, iv, passPhrase, json);
    return encrypt;
    // var decrypted = CryptoJS.AES.decrypt(encrypted, "Secret Passphrase");
}

////////////////////***************************** start of  pbkdf2 logic*****************************///////////////////////////////////////////////////////////////
