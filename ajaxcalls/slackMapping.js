...
function trackSelectedClouds() {
  ...
  if (selectedSource === "SLACK" && selectedDestination === "SLACK") {
    ...
    selectedDestination === "GOOGLE_CHAT"
  ) {
    $('[data-target="preMigration"]').css("display", "");
    $('[data-target="directMessages"]').css("display", "none");
    $('[data-target="slackMigrate"]').attr("data-val", 4);
    $('[data-target="slackMigrate"]').find(".badge").html("4");
    $('[data-target="slackMigrate"]').css("display", "");
    $("#changeNameBadge").html("User Mapping");
  } else if (
...
$("#forNextMove").click(function () {
  ...
  if (_step == 0) return false;
    ...
    if (localStorage.selDstnCloud === "MICROSOFT_TEAMS") {
    ...
    if (localStorage.selDstnCloud === "GOOGLE_CHAT") {
      $("#destinationImageAtUserMapping").attr(
        "src",
        "../img/PNG/GOOGLE_CHAT.png"
      );
    }
    ...
    if (selectedSource === "SLACK" && selectedDestination === "GOOGLE_CHAT") {
      runForStepThree(_step, "Slack");
      $("#mappingPreMigration").css("display", "");
      $("#mappingClouds").css("display", "none");
      $("#mappingUsers").css("display", "none");
    ...
    if (
      (selectedSource === "SLACK" && selectedDestination === "SLACK") ||
      (selectedSource === "SLACK" && selectedDestination === "GOOGLE_CHAT")
    ) {
      startStepThreeForSlack(_step);
      $("#privateChannelsTab").css("display", "");
      $("#syncChannels").css("display", "");
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (data[i].types === "public") {
            ...
            if (
              ...
              (localStorage.selSourceCloud === "SLACK" &&
                localStorage.selDstnCloud === "GOOGLE_CHAT")
            ) {
              cwidth = `width: 18%`;
            } else {
              cwidth = `width: 13%`;
    ...
    success: function (data) {
      ...
      if (data.length == 0) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          } else if (data[i]?.destCloudDetails?.name === "GOOGLE_CHAT") {
            imgDstn =
              '<img src="../img/PNG/GOOGLE_CHAT.png" style="height: 20px;width: 20px;vertical-align: -webkit-baseline-middle;margin-right: 2%;">';
          } else {
            imgDstn =
