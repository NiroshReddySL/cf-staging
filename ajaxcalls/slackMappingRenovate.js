...
function trackSelectedClouds() {
  ...
  if (selectedSource === "SLACK" && selectedDestination === "SLACK") {
    ...
    $('[data-target="slackMigrate"]').attr("data-val", 4);
    $('[data-target="slackMigrate"]').find(".badge").html("4");
  ...
  if ($(this).hasClass("active") || $(this).hasClass("completed")) {
    ...
    if (_step == 0) return false;
      ...
      if (selectedSource === "SLACK" && selectedDestination === "SLACK") {
        ...
        $("#forNextMove span").text("Next");
        $("#usersTab").click();
      } else if (localStorage.selSourceCloud === localStorage.selDstnCloud) {
        $("#mappingUsers").css("display", "");
        $("#mappingPreMigration").css("display", "none");
        $("#channelsTab").css("display", "none");
        $("#authenticateUsersTabSlack").css("display", "");
  ...
  slackChannelsRequest = $.ajax({
    ...
    success: function (data) {
      ...
      if (
        ...
        return false;
      } else if (data === "No Provision User Found") {
        $("#csvChannels").css("display", "");
        $("#CFShowLoading").hide();
        return false;
      } else {
      ...
      if (data.length > 0 && data !== "No Provision User Found") {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if ($("#selectAllChannels:checked").length) {
            var _input =
              '<input type="checkbox" name="channelSelect" object="' +
              data[i] +
              '" id="' +
              data[i].fromRootId +
              '"aid="' +
          ...
          if (data[i].types === "public") {
            var _html =
              ...
              destTeamName +
              '">' +
              CFManageCloudAccountsAjaxCall.getMaxChars(destTeamName, 45) +
              "</span></td>" +
              '<td style="width: 18%;"><span id="destChannelNameSpan" title="' +
              destChannelName +
              '">' +
              CFManageCloudAccountsAjaxCall.getMaxChars(destChannelName, 45) +
              "</span></td><td>" +
              prStat[data[i].processStatus] +
              "</td>" +
              "</tr>";
          } else {
            let cwidth;
      ...
      if (data.length == 0) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (data[i]?.destCloudDetails?.name === "SLACK") {
            imgDstn =
              '<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="20" height="20" viewBox="0 0 1024 1024"><path fill="#4A144B" d="M880 112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32zM529 311.4c0-27.8 22.5-50.4 50.3-50.4 27.8 0 50.3 22.6 50.3 50.4v134.4c0 27.8-22.5 50.4-50.3 50.4-27.8 0-50.3-22.6-50.3-50.4V311.4zM361.5 580.2c0 27.8-22.5 50.4-50.3 50.4-13.3 0-26.1-5.3-35.6-14.8-9.4-9.5-14.7-22.3-14.7-35.6 0-27.8 22.5-50.4 50.3-50.4h50.3v50.4zm134 134.4c0 27.8-22.5 50.4-50.3 50.4-27.8 0-50.3-22.6-50.3-50.4V580.2c0-27.8 22.5-50.4 50.3-50.4 13.3 0 26.1 5.3 35.6 14.8s14.7 22.3 14.7 35.6v134.4zm-50.2-218.4h-134c-27.8 0-50.3-22.6-50.3-50.4 0-27.8 22.5-50.4 50.3-50.4h134c27.8 0 50.3 22.6 50.3 50.4-.1 27.9-22.6 50.4-50.3 50.4zm0-134.4c-13.3 0-26.1-5.3-35.6-14.8S395 324.8 395 311.4c0-27.8 22.5-50.4 50.3-50.4 27.8 0 50.3 22.6 50.3 50.4v50.4h-50.3zm134 403.2c-27.8 0-50.3-22.6-50.3-50.4v-50.4h50.3c27.8 0 50.3 22.6 50.3 50.4 0 27.8-22.5 50.4-50.3 50.4zm134-134.4h-134c-13.3 0-26.1-5.3-35.6-14.8-9.4-9.5-14.7-22.3-14.7-35.6 0-27.8 22.5-50.4 50.3-50.4h134c27.8 0 50.3 22.6 50.3 50.4 0 27.8-22.5 50.4-50.3 50.4zm0-134.4H663v-50.4c0-27.8 22.5-50.4 50.3-50.4s50.3 22.6 50.3 50.4c0 27.8-22.5 50.4-50.3 50.4z"/></svg>';
          } else {
            imgDstn =
              '<img src="../img/PNG/MICROSOFT_TEAMS1.png" style="height: 20px;width: 20px;">';
          }
          ...
          $("#usersTable table tbody").append(`<tr data-attr="matchedUserPairs">
          <td style="padding-left: 2%;width: 40%;">
          ${
            data[i].sourceCloudDetails
              ? `<div class="cf_alignMappingUsers">
                ${imgSrc}
                <span
                  style="vertical-align: middle;"
                  title="${data[i].sourceCloudDetails.emailId}">
                  ${CFManageCloudAccountsAjaxCall.getMaxChars(
          ...
          </td> <td style="padding-left: 2%;width: 40%;">
          ${
            data[i].destCloudDetails
              ? `<div class="cf_alignMappingUsers">
                ${imgDstn}
                <span
                  style="vertical-align: middle;"
                  title="${data[i].destCloudDetails.emailId}">
                  ${CFManageCloudAccountsAjaxCall.getMaxChars(
          ...
          <td>${
            data[i].sourceCloudDetails && data[i].destCloudDetails
              ? "Matched"
              : "Not Matched"
          }</td>
          </tr>`);
...
$(document).on("change", "#selectAllChannels", function () {
  if ($(this).is(":checked")) {
    ...
    if ($(".filterTable").val() !== "") {
      $("#newChannelsSelCount").text($("input[name=channelSelect]").length);
    } else {
...
$(document).on("change", "input[name=channelSelect]", function () {
  ...
  if (
    ...
    $("input[name=channelSelect]").length
  ) {
  ...
  if ($("input[name=channelSelect]:checked").length > 1) {
    $("#mergeChannels").css("display", "flex");
  } else {
    $("#mergeChannels").css("display", "none");
  }

  if ($("input[name=channelSelect]:checked").length === 1) {
    $("#renameTemaAndChannels").css("display", "flex");
  } else {
    $("#renameTemaAndChannels").css("display", "none");
  }
});
...
$("#usersTab").click(function () {
  ...
  $(".filterUserTable").attr("placeholder", "Search By Source User Email");
  $(".filterUserTable").css("display", "");
  $(".filterUserTable").val("");
  $("#channelCnt").text("Mappings : ");
  $("#usersTable table tbody").html("");
  getSlackUsers(1);
  optionsToggler("users");
  $("#displayFooterTextChannels").css("display", "none");
  $("#displayFooterText").css("display", "none");
  $("#displayFooterTextUsersMapping").css("display", "flex");
  let selectedSource = localStorage.getItem("selSourceCloud") ?? "";
...
function migrateMsg() {
  $("#channelsTable table tbody tr").css("display", "");
  $("#directMsgsTable table tbody tr").css("display", "");
  var deltaCount = 0;
  ...
  if ($("input[name=messageSelect]:checked").length === 0) {
    ...
    if (
      ...
      var _url =
        apicallurl +
        "/messagemove/create/teams?willHaveDelta=false&deltaMigration=false";
    } else {
      var _url =
        apicallurl +
...
function getSlackReports(pgNo) {
  ...
  if ($("#channelsRepTab").hasClass("active")) {
    uri =
      apicallurl +
      "/messagemove/list/Channelworkspaces?page_size=50&page_nbr=" +
      pgNo +
      "&isAscen=false&orderField=createdTime";
  } else if ($("#directMsgsRepTab").hasClass("active")) {
    uri =
      apicallurl +
  ...
  if ($("#slackOneTime").hasClass("active")) {
    uri = uri + "&Jobtype=ONETIME";
  } else {
    uri = uri + "&Jobtype=DELTA";
  }
  $.ajax({
    type: "GET",
    url: uri,
    ...
    success: function (data) {
      ...
      if (data.length == 0) {
        ...
        if ($("#channelsRepTab").hasClass("active")) {
          appendSlackChannelsReports(data);
        } else if ($("#directMsgsRepTab").hasClass("active")) {
          appendSlackDMReports(data);
        }
        setTimeout(function () {
          $("#CFShowLoading").hide();
        }, 1000);
...
function appendSlackChannelsReports(data) {
  for (var i = 0; i < data.length; i++) {
    let toCloudAdminId, fromCloudAdminId;
    var processStat = data[i].processStatus;
    if (data[i].directOrGroupMessage == false) {
      if (
      ...
      if (
        ...
        data[i].fromCloudId !== null &&
        data[i].toCloudName === "MICROSOFT_TEAMS"
      ) {
        if (
          ...
          var selectMultiDelta = `<input type="checkbox" id="multiSelectForDelta" dstndeligate="${
            data[i].destDelegateCloudId
          }" srcdeligate="${data[i].sourceDelegateCloudId}" srcDeltaId="${
            data[i].sourceDeltaId
          }" cid="${fromCloudAdminId}" tocid="${toCloudAdminId}"
         fromrootid="${data[i].fromRootId}" torootid="${
            data[i].toRootId
          }" cname="${data[i].channelName}" ctype="${data[i].channelType}"
        wname="${data[i].workSpaceName}" destchannelname="${escapeSpecialChar(
            data[i].destChannelName
          )}" dstteamname="${escapeSpecialChar(
            data[i].destTeamName
          )}" srcChannelId="${data[i].srcChannelId}"
        sourceDeltaId="${data[i].sourceDeltaId}" cloudName="${
            data[i].fromCloudName
          }" tocloudname="${data[i].toCloudName}" channelid="${
            data[i].channelId
          }">`;
        } else {
      ...
      var _html =
        ...
        data[i].channelType +
        '" channelname="' +
        escapeSpecialChar(data[i].channelName) +
        '" channeldate="' +
        data[i].channelDate +
        '"><td style="width:5px;">' +
        selectMultiDelta +
...
function appendSlackDMReports(data) {
  for (var i = 0; i < data.length; i++) {
    let toCloudAdminId, fromCloudAdminId;

    var processStat = data[i].processStatus;
    if (data[i].directOrGroupMessage == true) {
      if (
        data[i].toCloudId === null ||
        data[i].toCloudId.adminCloudId === null ||
        data[i].toCloudId.adminCloudId === undefined ||
...
$(document).on("click", "#destTeamEdit", function () {
  ...
  $("input#teamName").keydown(function (event) {
    if (event.keyCode == 13) {
      ...
      if (Updatedusername.length == 0) {
        ...
        _thisBox.text(CFManageCloudAccountsAjaxCall.getMaxChars(user_name, 30));
        _thisBox.siblings().show();
        $("#CFShowLoading").modal("hide");
      } else if (
        localStorage.selSourceCloud === "SLACK" &&
        localStorage.selDstnCloud === "MICROSOFT_TEAMS" &&
        Updatedusername.length > 256
      ) {
        Updatedusername = CFManageCloudAccountsAjaxCall.getMaxChars(
          Updatedusername,
          30
        );
        alertError("Maximum 256 Characters are allowed for Team name");
      } else {
  ...
  $("body").on("mouseup", function (e) {
    ...
    if (!container.is(e.target) && container.has(e.target).length === 0) {
      ...
      _thisBox.text(CFManageCloudAccountsAjaxCall.getMaxChars(userName, 30));
      _thisBox.siblings().show();
      $("body").off("mouseup");
    }
  });
    ...
    if (event.keyCode == 13) {
      ...
      if (Updatedusername.length == 0) {
        ...
        if (
          localStorage.selSourceCloud === "SLACK" &&
          localStorage.selDstnCloud === "MICROSOFT_TEAMS" &&
          Updatedusername.length > 50
        ) {
          alertError("Maximum 50 Characters are allowed for channel name");
          return false;
        }
        if (
          localStorage.selSourceCloud === "SLACK" &&
...
$("#channelsRepTab").click(function () {
  ...
  $("#slackTabbing").css("display", "flex");
  $("#slackDelta").removeClass("active");
  $("#slackOneTime").addClass("active");
  getSlackReports();
  $('[class="destinationUserTable"]').css("display", "");
  $('[class="destinationUserTable"]').val("");
});
...
function getCloseTeamsReports(pgNo) {
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data === "Not initiated any migration yet..") {
        if (pgNo === 1) {
          alertSuccess("Not initiated any migration yet..");
        }
        return false;
      }
...
function sendSlackEmail(clId) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      getTotalUsersCount("emailRequest");
      setTimeout(function () {
        $("#CFShowLoading").hide();
      }, 1000);
    },
...
$(document).on("click", '[id="deltaslack"]', function () {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $("#slackDelta").addClass("active");
      $("#slackOneTime").removeClass("active");
      getSlackReports();
    },
    error: function (err) {
      $("#CFShowLoading").hide();
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data == "Your Request is Already under processing") {
        ...
        localStorage.setItem("channelspremigrationstatus", data?.processStatus);
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data == "Your Request is Already under processing") {
        ...
        localStorage.setItem("dmspremigrationstatus", data?.processStatus);
        $(".showStatusPreMigration")
          .css({ display: "", color: "#FFB900", border: "1px solid #FFB900" })
          .find("span")
          .html("In-Progress");
        ...
        localStorage.setItem("premigrationstatus", "completed");
        if (
          localStorage.dmspremigrationstatus === "PROCESSED" &&
          localStorage.channelspremigrationstatus === "PROCESSED"
        ) {
          $(".showStatusPreMigration")
            .css({ display: "", color: "#00C64F", border: "1px solid #00C64F" })
            .find("span")
...
$(document).on("input", "#channelsName", function () {
  if (
    ...
    const restrictedChars =
      /^_|[\~\#\%\&\*\{\}\+\/\\\:\>\<\?\'\"\,\.\.\\\/\|]|CON|CONIN\$|CONOUT\$|PRN|AUX|NUL|COM[1-9]|LPT[1-9]|desktop\.ini|_vti_/gi;
    if ($(this).val().startsWith("_")) {
      alertError('Teams won\'t accept "_" as a first character');
      $(this).val($(this).val().substring(1));
    } else if ($(this).val().endsWith(".")) {
      alertError('Teams won\'t accept "." as a last character');
      $(this).val(
        $(this)
          .val()
          .substring(0, $(this).val().length - 1)
      );
    } else if (restrictedChars.test($(this).val())) {
      alertError(
        `Teams won\'t accept following characters ~ # % & * { } + / \ : < > ? | ' " , .. forms, CON, CONIN$, CONOUT$, PRN, AUX, NUL, COM1 to COM9, LPT1 to LPT9, desktop.ini, _vti_`
      );
      $(".alertErr").css("height", "130px");
      setTimeout(() => {
        $(".alertErr").css("height", "90px");
      }, 5000);
      $(this).val(
        $(this)
          .val()
          .replaceAll(
            /[\~\#\%\&\*\{\}\+\/\\\:\>\<\?\'\"\,\.\.\\\/\|\s]|CON|CONIN\$|CONOUT\$|PRN|AUX|NUL|COM[1-9]|LPT[1-9]|desktop\.ini|_vti_/gi,
            ""
          )
      );
    }
...
$("#searchDmsIcons").click(function () {
  if ($(this).hasClass("fa-times")) {
    ...
    $(this).addClass("fa-times").removeClass("fa-search");
    if ($("#dstnUsersTab").hasClass("active")) {
      $('[class="destinationUserTable"]').css({ display: "", marginLeft: "0" });
      $('[class="destinationUserTable"]').val("");
    } else if ($("#directMsgsTab").hasClass("active")) {
      $('[class="searchDMSHERE"]').css({ display: "", marginLeft: "-20px" });
      $('[class="searchDMSHERE"]').val("");
    } else {
      $('[class="sourceUserTable"]').css({ display: "", marginLeft: "0" });
      $('[class="sourceUserTable"]').val("");
    }
  }
});
...
function searchUserData(userEmail) {
  ...
  userMappingSearchRequest = $.ajax({
    ...
    success: function (data) {
      if (data) {
        ...
        $("#usersTable table tbody").html(`<tr data-attr="matchedUserPairs">
        <td style="padding-left: 2%;width: 40%;">
        ${
...
function cancelRequest(at) {
  ...
  } else if (at === "slackChannels") {
    if (slackChannelsRequest) {
      slackChannelsRequest.abort();
      console.log("Slack Channels Requested Aborted Successfully");
    }
  }
}

$("#slackOneTime").on("click", function () {
  $("#CFShowLoading").show();
  $(this).addClass("active");
  $("#slackDelta").removeClass("active");
  getSlackReports();
...
function optionsToggler(origin) {
  $("#renameTemaAndChannels").css("display", "none");
  $("#mergeChannels").css("display", "none");
  $("#deleteToggler").css("display", "none");
  if (origin === "users") {
    $(".downlaodToggler").attr("id", "downloadUserMappings");
    $('[data-only="channels"]').css("display", "none");
  } else {
    $("#searchToggler").attr("placeholder", "Search By Slack Channel Name");
  }
}

$("#downlaodToggler").on("click", function () {
  if ($("#usersTab").hasClass("active")) {
    dwnldUserMapping();
  } else {
    getChannelsCSV();
...
$("#deleteToggler").on("click", function () {
  if ($("#usersTab").hasClass("active")) {
    deleteMapping("");
  }
});

$("#searchToggler").on("input", function () {
  if ($("#usersTab").hasClass("active")) {
    if (isValidEmail($(this).val())) {
      console.log($(this).val());
      cancelRequest("searchUserMapping");
      searchUserData($(this).val());
    }
    if ($(this).val().length === 0 || $(this).val() === "") {
      getSlackUsers(1);
    }
...
$("#mergeChannels").on("click", function () {
  $(".mergeTeam-Parent").css("display", "flex");
  $("#mergerInputError").css("display", "none");
  $("#mergeTeamName").focus();
  $("#mergeTeamName").val("");
});

$("#closeMergeTeams").on("click", function () {
  $(".mergeTeam-Parent").css("display", "none");
});

$("#ctaMeargeTeams").on("click", function () {
  let newTeamName = $("#mergeTeamName").val();
  if (newTeamName.length === 0) {
    $("#mergerInputError").css("display", "");
    $("#mergerInputError").html("*Team Name Should not be empty");
    return false;
  }
  $("#mergerInputError").css("display", "none");
  $(".mergeTeam-Parent").css("display", "none");
  $.each($("input[name=channelSelect]:checked"), function () {
    $(this).attr("destteamname", newTeamName);
    $(this)
      .parent()
      .siblings()
      .find("#destTeamNameSpan")
      .html(CFManageCloudAccountsAjaxCall.getMaxChars(newTeamName, 40));
    $(this)
      .parent()
      .siblings()
      .find("#destTeamNameSpan")
      .attr("title", newTeamName);
  });
});

$("#renameTemaAndChannels").on("click", function () {
  $(".renameTemaAndChannels-Parent").css("display", "flex");
  $("#reNameInputError").css("display", "none");
  $("#editNewDstnChannelName").val(
    $("input[name=channelSelect]:checked").attr("destchannelname")
  );
  $("#editNewDstnTeamName").val(
    $("input[name=channelSelect]:checked").attr("destteamname")
  );
});

$("#closeEditTeamsChannels").on("click", function () {
  $(".renameTemaAndChannels-Parent").css("display", "none");
});

$("#ctaEditTeamsChannels").on("click", function () {
  $(".renameTemaAndChannels-Parent").css("display", "none");
  let newTeamName = $("#editNewDstnTeamName").val();
  let newChannelName = $("#editNewDstnChannelName").val();

  $("input[name=channelSelect]:checked")
    .parent()
    .siblings()
    .find("#destTeamNameSpan")
    .attr("title", newTeamName)
  ...
  $("input[name=channelSelect]:checked")
    .parent()
    .siblings()
    .find("#destChannelNameSpan")
    .attr("title", newChannelName)
    .html(newChannelName);
});
