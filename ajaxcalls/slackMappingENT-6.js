  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.length == 0) {
        ...
        let count = Math.ceil(data[0].noOfMappedCloudPressent / pageSize);

        $(".userMappingPagination").twbsPagination({
          totalPages: count,
          visiblePages: 8,
          startPage: 1,
        ...
        if ($("#srcUsersTab").hasClass("active")) {
          ...
          for (var i = 0; i < data.length; i++) {
            if (data[i].provisioned == true) {
              pubCount++;
              var _html =
                '<tr><td style="padding-left: 3%;vertical-align: middle;padding-top: 1%;width:50px;"><input disabled type="checkbox" name="selectSrcUsers" id="' +
                data[i].id +
                '" adminid="' +
                data[i].adminCloudId +
                '" cloudid="' +
              ...
              if (data[i].emailSent == false) {
                var _html =
                  '<tr><td style="padding-left: 3%;vertical-align: middle;padding-top: 1%;width:50px;"><input type="checkbox" name="selectSrcUsers" id="' +
                  data[i].id +
                  '" adminid="' +
                  data[i].adminCloudId +
                  '" cloudid="' +
          ...
          for (var i = 0; i < data.length; i++) {
            if (data[i].provisioned == true) {
              pubCount++;
              var _html =
                '<tr><td style="padding-left: 3%;vertical-align: middle;padding-top: 1%;width:50px;"><input disabled type="checkbox" name="selectDstnUsers" id="' +
                data[i].id +
                '" adminid="' +
                data[i].adminCloudId +
                '" cloudid="' +
              ...
              if (data[i].emailSent == false) {
                var _html =
                  '<tr><td style="padding-left: 3%;vertical-align: middle;padding-top: 1%;width:50px;"><input type="checkbox" name="selectDstnUsers" id="' +
                  data[i].id +
                  '" adminid="' +
                  data[i].adminCloudId +
                  '" cloudid="' +
