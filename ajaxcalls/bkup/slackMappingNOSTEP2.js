...
break;
    ...
    var _html = '<tr fromRootId="'+data[i].id+'"><td style="width: 1%;">'+_input+'</td><td style="width:18%;" title="'+data[i].channelName+'" id="public"><i class="fa fa-hashtag" style="color:#000;font-size: 10px !important;font-weight:100 !important;"></i>&nbsp;'+CFManageCloudAccountsAjaxCall.getMaxChars(data[i].channelName, 16)+'</td>'+
	 ...
	 //'<td style="width: 16%;"><select id="JobType_dropDown" style=""><option>One Time</option><option>Delta</option></select></td>'+
	 '<td style="width: 16%;"><select id="msgType_dropDown" style=""><option>Team</option><option>Sub-Channel</option></select></td>'+
	 '<td style="width: 19%;"><span id="destTeamNameSpan" title="'+destTeamName+'">'+CFManageCloudAccountsAjaxCall.getMaxChars(destTeamName, 14)+'</span><i class="lnil lnil-pencil" id="destTeamEdit" channelobject='+JSON.stringify(data[i])+' style="font-weight: 600;font-size: 15px;float: right;margin-right: 15%;"></i></td>'+
	 '<td style="width: 18%;"><span id="destChannelNameSpan" title="'+destChannelName+'">'+CFManageCloudAccountsAjaxCall.getMaxChars(destChannelName, 14)+'</span><i class="lnil lnil-pencil" id="destChannelEdit" channelobject='+JSON.stringify(data[i])+' style="font-weight: 600;font-size: 15px;float: right;margin-right: 15%;"></i></td>'+
	 '</tr>';
		}else{
...
_thisBox.siblings().show();			
	...
	let obj = JSON.parse(selectedObject)
	if(type === "team"){
