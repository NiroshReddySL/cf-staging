        ...
        if (
          ...
          if (
            ...
            var html =
              ...
              '<div style="width: 10%;padding: 2.7% 1%;float:left;margin-left: 15px;" class="dropdown"><i class="lnil lnil-cloud-search" title="" style="font-size: 25px; color: #1220f6; font-weight: bolder;margin-left:30px"></i><div class="dropdown-content"><button class="dropdown" type="button" id="showSummery"  cuid="' +
              AllCloudsInfo[i].userId +
              '" uid="' +
              AllCloudsInfo[i].id +
              '" style="display: inline-block;background-color: #fcfcfc;color: #1220f6;border: none;border-radius: 3px;z-index: 999999;width: 100%;outline: none;" onclick="showPremigDivAlna(this)"><a style="color: #1220f6;text-decoration: underline;">Quick Scan</a></button><button class="dropdown" type="button"  cuid="' +
              AllCloudsInfo[i].userId +
              '" uid="' +
              AllCloudsInfo[i].id +
              '" style="display: inline-block;background-color: #fcfcfc;color: #1220f6;border: none;border-radius: 3px;z-index: 999999;width: 100%;outline: none;" onclick=""><a style="color: #1220f6;text-decoration: underline;">Deep Scan</a></button></div></div>' +
        ...
        for (let i = 0; i <= data.length; i++) {
          ...
          $("#nan").append(
            '<tr> <td style="padding: 12px 16px">' +
              ...
              emailId +
              '</td> <td style="padding: 12px 16px"></td> <td style="padding: 12px 16px"></td> <td style="width: 25%"> <progress style="width:250px;" value="' +
              usedSpace +
              '" max="' +
              totalSpace +
              '" ></progress> <br /> <span> ' +
