...
var CFManageCloudAccountsAjaxCall = {
  ...
  getAllClouds: function (src, dstn, page) {
    if (localStorage.UserId === "60119846e4b089b81ae653ff0") {
  ...
  getAllCloudTitlesSettings: function (CloudName, CloudId) {
    ...
    for (var i = 0; i < CloudName.length; i++) {
      if (AllCloudsInfo[i].userType === "ADMIN") {
        if (
          ...
          if (
            ...
            if (AllCloudsInfo[i].cloudName === "SHAREFILE_BUSINESS") {
              console.log(null);
            } else {
      ...
      // if (AllCloudsInfo[i].cloudName === "G_SUITE") {
      //   $("#manageclouddiv")
      //     .children("div")
      //     .append(appendhtml.replaceAll(AllCloudsInfo[i].id, "test"));
      // }
