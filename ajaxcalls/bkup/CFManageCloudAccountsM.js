...
var CFManageCloudAccountsAjaxCall = {
    ...
    CloudSyncStatus: function (cloudid) {
		...
		AllCloudsInfo.forEach((res) =>{
         if(res.cloudName === "MURAL"){
          if(res.id === cloudid){
           $('[name="MURAL"]').siblings(".appendcloudDetails").find(".table-responsive table tbody").find(".CloudSync").find('td:eq(0)').find('div:eq(0)').attr("id","MURALUSERS")
$('[id="MURALUSERS"]').html("Total Users")
$('[name="MURAL"]').siblings(".appendcloudDetails").find(".table-responsive table tbody").find(".CloudSync").find('td:eq(0)').find('div:eq(1)').attr("id","TOTALUSERSCOUNT")
$('[id="TOTALUSERSCOUNT"]').html("50")
$('[name="MURAL"]').siblings(".appendcloudDetails").find(".table-responsive table tbody").find(".CloudSync").find('td:eq(1)').find('div:eq(0)').attr("id","ActiveUsers")
$('[id="ActiveUsers"]').html("Active Users")
$('[name="MURAL"]').siblings(".appendcloudDetails").find(".table-responsive table tbody").find(".CloudSync").find('td:eq(1)').find('div:eq(1)').attr("id","ActiveUsersCount")
$('[id="ActiveUsersCount"]').html("40")
$('[name="MURAL"]').siblings(".appendcloudDetails").find(".table-responsive table tbody").find(".CloudSync").find('td:eq(2)').find('div:eq(0)').attr("id","TotalMurals")
$('[id="TotalMurals"]').html("Total Murals")
$('[name="MURAL"]').siblings(".appendcloudDetails").find(".table-responsive table tbody").find(".CloudSync").find('td:eq(2)').find('div:eq(1)').attr("id","TotalMuralsCount")
$('[id="TotalMuralsCount"]').html("150")
$('[name="MURAL"]').siblings(".appendcloudDetails").append('<div class="slackChartContainer" style="display: flex; justify-content: space-between;width: 100%;margin-top:-20px;" > <div class="usersTable" style="margin-left: 0px;"> <table class="table" style="width: 600px; margin-top: 80px"> <thead> <tr style=" background: #0062ff; color: #fff; height: 40px !important; position: absolute; margin-top: -40px; width: 600px; " > <td style="width: 448px; height: 40px"> <span style="margin-left: 10px"> Users Name</span> </td> <td style="width: 254px; height: 40px"> Status <span class="dropdown" ><i class="fa fa-filter dropbtn" style="margin-left: 50%"></i> <div class="dropdown-content" style=" font-weight: 500; font-size: 12px; top: 85%; left: -15%; " id="dropPubPvt" > <a ><i class="fa fa-check-circle all" style="color: green" ></i ><span style="margin-left: 5%">All</span></a ><a ><i class="fa fa-check-circle public" style="color: green; display: none" ></i ><span style="margin-left: 5%">Active</span></a ><a >'+
'<i class="fa fa-check-circle private" style="color: green; display: none" ></i ><span style="margin-left: 5%">In-Active</span></a > </div></span > </td> <td style="width: 235px; height: 40px">Mural Count</td> </tr> </thead> <tbody style="display: block;width: 600px;height: 260px;overflow: scroll;"> <tr> <td style="width: 278px">Testing</td> <td style="width: 196px;">Active</td> <td style="width: 125px;">20</td> </tr> <tr> <td style="width: 278px">Testing-2</td> <td>Active</td> <td>30</td> </tr> <tr> <td style="width: 278px">Testing-3</td> <td>In-Active</td> <td>10</td> </tr><tr> <td style="width: 278px">James</td> <td>Active</td> <td>24</td> </tr> <tr> <td style="width: 278px">Test-0</td> <td>Active</td> <td>21</td> </tr> <tr> <td style="width: 278px">Test-1</td> <td>Active</td> <td>45</td> </tr> <tr> <td style="width: 278px">Test-2</td> <td>In-Active</td> <td>23</td> </tr> <tr> <td style="width: 278px">Derrick</td> <td>Active</td> <td>56</td> </tr>'+
'<tr> <td style="width: 278px">Test-12</td> <td>In-Active</td> <td>33</td> </tr> <tr> <td style="width: 278px">Test-20</td> <td>In-Active</td> <td>18</td> </tr> </tbody> </table> </div> <div class="usersTable"> <table class="table" style="width: 600px; margin-top: 80px"> <thead> <tr style=" background: #0062ff; color: #fff; height: 40px !important; position: absolute; margin-top: -40px; width: 600px; " > <td style="width: 332px; height: 40px"> <span style="margin-left: 10px">Room Name</span> </td> <td style="width: 332px; height: 40px"> Room Type <span class="dropdown" ><i class="fa fa-filter dropbtn" style="margin-left: 50%"></i> <div class="dropdown-content" style=" font-weight: 500; font-size: 12px; top: 85%; left: -15%; " id="dropPubPvt" > <a ><i class="fa fa-check-circle all" style="color: green" ></i ><span style="margin-left: 5%">All</span></a ><a ><i class="fa fa-check-circle public" style="color: green; display: none" ></i >'+
'<span style="margin-left: 5%">Public</span></a ><a ><i class="fa fa-check-circle private" style="color: green; display: none" ></i ><span style="margin-left: 5%">Private</span></a > </div></span > </td> <td style="width: 235px; height: 40px">Murals</td> </tr> </thead> <tbody style="display: block;width: 600px;height: 260px;overflow: scroll;"> <tr> <td style="width: 238px">Testing Mural</td> <td style="width: 220px;">Public</td> <td style="width: 140px;">22</td> </tr> <tr> <td style="width: 220px">untitled mural</td> <td>Private</td> <td>40</td> </tr> <tr> <td style="width: 238px">untitled mural-2</td> <td>Public</td> <td>33</td> </tr> <tr> <td style="width: 220px">untitled mural-3</td> <td>Public</td> <td>21</td> </tr> <tr> <td style="width: 238px">untitled mural-4</td> <td>Public</td> <td>23</td> </tr> <tr> <td style="width: 220px">untitled mural-5</td> <td>Private</td> <td>19</td> </tr>'+
'<tr> <td style="width: 238px">untitled mural-6</td> <td>Public</td> <td>18</td> </tr> <tr> <td style="width: 220px">untitled mural-7</td> <td>Private</td> <td>8</td> </tr> <tr> <td style="width: 238px">untitled mural-8</td> <td>Public</td> <td>16</td> </tr> <tr> <td style="width: 220px">untitled mural-9</td> <td>Private</td> <td>28</td> </tr> </tbody> </table> <div class="btn btn-primary" title="Download Mapping" style=" cursor: pointer; font-weight: 500; border-radius: 3px; float: right; margin-top: 1%; width: 97px; height: 35px; font-size: 14px; " > Download </div> </div>')
     	  }
      	 }
	})
