...
var CFManageCloudAccountsAjaxCall = {
	...
	'<div style="width: 100%;" id="incrementProgress"><p id="usersDisplay" style="color: #707070;font-size: 12px;width: 135px;float: left;margin-bottom: 2%;">0 out of 0 Users </p><span id="percentOfUsers" style="font-size: 12px;font-weight: 600;float: left;color: #000;">0%</span>'+
	...
	'<div id="mngCloudName" style="width: 22%;padding:2.7% 1%;float:left;color:#1F2129;font-weight:500;"><span>' + CLName[CloudName[i]] + '</span></div>'+
	'<div id="mngCloudData" style="width: 20%;padding: 2% 1%;float:left;">'+
	'<div style="width: 100%;" id="incrementProgress"><p id="usersDisplay" style="color: #707070;font-size: 12px;width: 135px;float: left;margin-bottom: 2%;">'+prvsnLen+' out of ' + totalCount + ' Users </p><span id="percentOfUsers" style="font-size: 12px;font-weight: 600;float: left;color: #000;">100%</span>'+
	...
	'<div id="mngCloudName" style="width: 22%;padding:2.7% 1%;float:left;color:#1F2129;font-weight:500;"><span>' + CLName[CloudName[i]] + '</span></div>'+
	'<div id="mngCloudData" style="width: 20%;padding: 2% 1%;float:left;">'+
	'<div style="width: 100%;" id="incrementProgress"><p id="usersDisplay" style="color: #707070;font-size: 12px;width: 135px;float: left;margin-bottom: 2% 1%;">'+totalCount+' out of ' + totalCount + ' Users </p><span id="percentOfUsers" style="font-size: 12px;font-weight: 600;float: left;color: #000;">100%</span>'+
	...
	'<div style="width: 100%;" id="incrementProgress"><p id="usersDisplay" style="color: #707070;font-size: 12px;width: 135px;float: left;margin-bottom: 2% 1%;">'+_progress+' out of ' + totalCount + ' Users </p><span id="percentOfUsers" style="font-size: 12px;font-weight: 600;float: left;color: #000;">0%</span>'+
	...
	'<div class="appendcloudDetails" style="width: 96%;margin: 2%;border-radius: 5px;display:none"></div></div>';
            ...
            if(AllCloudsInfo[i].cloudName === "DROPBOX_BUSINESS") {
			  ...
			  if(AllCloudsInfo[i].cloudName === "ONEDRIVE_BUSINESS_ADMIN" || AllCloudsInfo[i].cloudName === "BOX_BUSINESS" ||AllCloudsInfo[i].cloudName === "SHAREPOINT_ONLINE_BUSINESS") {
                       $('#manageclouddiv #' + AllCloudsInfo[i].id ).parent().find('#AuthorizeCld').css('display','none').removeClass('retry');
...
if(_srcCldName == "FTP" ||_dstCldName == "SHAREPOINT_ONLINE_CONSUMER" || (_srcCldName == "NTLM_STORAGE" && _dstCldName == "G_DRIVE") || (_srcCldName == "NTLM_STORAGE" && _dstCldName == "SHARED_DRIVES")){
    ...
    fileFolderCount: function (a,_this) {
		...
		else if((_this.parents('tr:eq(0)').attr('srccldname') == "BOX_BUSINESS" && _this.parents('tr:eq(0)').attr('dstncldname') == "DROPBOX_BUSINESS")||(_this.parents('tr:eq(0)').attr('srccldname') == "G_SUITE" && _this.parents('tr:eq(0)').attr('dstncldname') == "DROPBOX_BUSINESS")){ 
