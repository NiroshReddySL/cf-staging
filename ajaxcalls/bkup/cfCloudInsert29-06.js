...
function apiPutData(userId,cloudaccesstoken,cloudrefreshtoken,cloudUserId,cloudName,userDisplayName,authorizationCode) {
    var arr1;
    ...
    $.ajax({
        ...
        headers: {
            ...
            "Authorization": make_base_auth(userId, getValidToken(userId))
