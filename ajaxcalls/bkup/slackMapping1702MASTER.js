        ...
        for (var i = 0; i < data.length; i++) {
          if (
            ...
            var _html =
              ...
              "</td><td>" +
              prStat[processStat] +
              '</td><td><button style="background: #1220F6 0% 0% no-repeat padding-box;color: #fff;border: 0px;height: 25px;border-radius: 4px;font-weight: 500;opacity:0.4;pointer-events:none;">Initiate Delta</button></td><td style="text-align:center;"><i class="lnil lnil-download" id="slackChannelReport" style="color:#0062ff;font-size: 16px;font-weight: bold;"></i></td></tr>';
            $("#channelsTable table tbody").append(_html);
          } else if (
