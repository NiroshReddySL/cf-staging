        ...
        if (
          ...
          if (
            ...
            var html =
              ...
              AllCloudsInfo[i].id +
              '" style="display: inline-block;background-color: #fcfcfc;color: #1220f6;border: none;border-radius: 3px;z-index: 999999;width:91px;" onclick="showPremigDivAlna(this)"><a href="#"><u>Quick Scan</u></a></button></div>' +
...
var tableAnalysisData =
  '<div class="parent"> <div class="div1"> <div class="tSummData" style="font-size: 16px; font-weight: 600; margin: 9px" > Summary </div> </div> <div class="div2"> <i class="fa fa-user" style="font-size: 24px"></i> <div class="tSummDataHead">Active Users</div> <div class="tSummData">5</div> </div> <div class="div3"> <i class="fa fa-folder" style="font-size: 24px"></i> <div class="tSummDataHead">Total Folders</div> <div class="tSummData">500</div> </div> <div class="div4"> <i class="fa fa-file" style="font-size: 24px"></i> <div class="tSummDataHead">Total Files</div> <div class="tSummData">25000</div> </div> <div class="div5"> <div class="ape"> <i class="fa fa-database" style="font-size: 24px"></i> <div class="tSummDataHead">Total Size</div> <div class="tSummData">5TB</div> </div> </div> <div class="div6"> <div class="tSummDataHeadinfo">Maximum file count</div> <div class="tSummData" style=" color: #0062ff; font-size: 15px; margin: 6px 6px; margin-top: 10px; " > ben@syncorbit.com [2323] </div> </div> <div class="div7"> <div class="tSummDataHeadinfo">Maximum Used Space</div> <div class="tSummData" style=" color: #0062ff; font-size: 15px; margin: 6px 6px; margin-top: 10px; " > ben@syncorbit.com [100GB] </div> </div> <div class="div8"> <div class="tableFixHeadPreMigrate"> <table id="preMigrationAnalysisTable"> <thead> <tr> <th scope="col" style="text-align: center">S.No</th> <th scope="col" style="text-align: center"> Email Id <span style="margin-bottom: 3px" ><input type="email" placeholder="Email Id" style=" color: #777; font-weight: 400; width: 184px; height: 26px; padding: 1px 2px; " id="searchEmailInPreMig" /><i class="fa fa-search" style="margin-left: -30px; color: black" ></i ></span> </th> <th scope="col" style="text-align: center">Total Folders</th> <th scope="col" style="text-align: center"> Total Files<i class="fa fa-sort" type="button" style="margin-top: 0%; font-size: 18px; padding-left: 3px" ></i> </th> <!-- <th scope="col" style="text-align: center">Used Space<i class="fa fa-sort" type="button" style="margin-top: 0%;font-size: 18px;padding-left: 3px;"></i></th> --> <!-- <th scope="col" id="AVB" style="text-align: center">User Data Space</th> --> <th scope="col" id="TotalSpace" style=" text-align: center; /* width: 66%; */ /* float: right; */ " > User Data Space <i class="lnil lnil-download" style=" /* color:#0062ff; */ margin-left: 5%; width: 15%; font-size: 16px; font-weight: bold; " title="Download Report" ></i> <button type="button" id="downloadReport" style=" width: auto; /* float: right; */ display: inline-block; display: none; background-color: #1220f6; color: #fff; border: none; border-radius: 3px; /* padding: 1% 1%; */ padding-right: 14px; /* transform: translate(14px); */ " > Download &nbsp; <i class="lnil lnil-download" style=" /* color:#0062ff; */ /* margin-left: 2%; */ /* width: 21%; */ font-size: 16px; float: right; font-weight: bold; " title="Download Report" ></i> </button> </th> </tr> </thead> <tbody id="tbPreMigAnal"> <tr> <td id=" " style="padding: 12px 16px">1</td> <td id=" " style="padding: 12px 16px; width: 25%"> ben@filefuze.co </td> <td id=" " style="padding: 12px 16px">120</td> <td id=" " style="padding: 12px 16px">15100</td> <td style="width: 25%"> <progress value="100" max="300"></progress><br /><span >1 TB Data used of 3TB</span > </td> </tr> <tr> <td id=" " style="padding: 12px 16px">2</td> <td id=" " style="padding: 12px 16px; width: 25%"> leo@syncorbit.com </td> <td id=" " style="padding: 12px 16px">100</td> <td id=" " style="padding: 12px 16px">9000</td> <td style="width: 25%"> <progress value="120" max="300"></progress><br /><span >1.2 TB Data used of 3TB</span > </td> </tr> <tr> <td id=" " style="padding: 12px 16px">3</td> <td id=" " style="padding: 12px 16px; width: 25%"> kent@syncorbit.com </td> <td id=" " style="padding: 12px 16px">132</td> <td id=" " style="padding: 12px 16px">1014500</td> <td style="width: 25%"> <progress value="100" max="200"></progress><br /><span >1 TB Data used of 2TB</span > </td> </tr> <tr> <td id=" " style="padding: 12px 16px">4</td> <td id=" " style="padding: 12px 16px; width: 25%"> dan@syncorbit.com </td> <td id=" " style="padding: 12px 16px">1400</td> <td id=" " style="padding: 12px 16px">350142</td> <td style="width: 25%"> <progress value="270" max="500"></progress><br /><span >2.7 TB Data used of 5TB</span > </td> </tr> <tr> <td id=" " style="padding: 12px 16px">5</td> <td id=" " style="padding: 12px 16px; width: 25%"> barry@syncorbit.com </td> <td id=" " style="padding: 12px 16px">3</td> <td id=" " style="padding: 12px 16px">7</td> <td style="width: 25%"> <progress value="50" max="200"></progress><br /><span >0.5 TB Data used of 2TB</span > </td> </tr> <tr> <td id=" " style="padding: 12px 16px">6</td> <td id=" " style="padding: 12px 16px; width: 25%"> alex@filefuze.co </td> <td id=" " style="padding: 12px 16px">20</td> <td id=" " style="padding: 12px 16px">300</td> <td style="width: 25%"> <progress value="220" max="300"></progress><br /><span >2.2 TB Data used of 3TB</span > </td> </tr> <tr> <td id=" " style="padding: 12px 16px">7</td> <td id=" " style="padding: 12px 16px; width: 25%"> roy@snapbot.io </td> <td id=" " style="padding: 12px 16px">2</td> <td id=" " style="padding: 12px 16px">10</td> <td style="width: 25%"> <progress value="400" max="3000"></progress><br /><span >4 GB Data used of 3TB</span > </td> </tr> <tr> <td id=" " style="padding: 12px 16px">8</td> <td id=" " style="padding: 12px 16px; width: 25%"> erik@filefuze.co </td> <td id=" " style="padding: 12px 16px">0</td> <td id=" " style="padding: 12px 16px">0</td> <td style="width: 15%"> <progress value="450" max="3000"></progress><br /><span >4.3 TB Data used of 3TB</span > </td> </tr> <tr> <td id=" " style="padding: 12px 16px">9</td> <td id=" " style="padding: 12px 16px; width: 25%"> t-0.m_my@snapbot.io </td> <td id=" " style="padding: 12px 16px">25</td> <td id=" " style="padding: 12px 16px">456</td> <td style="width: 25%"> <progress value="100" max="300"></progress><br /><span >1 GB Data used of 3GB</span > </td> </tr> <tr> <td id=" " style="padding: 12px 16px">10</td> <td id=" " style="padding: 12px 16px; width: 25%"> max@snapbot.io </td> <td id=" " style="padding: 12px 16px">100</td> <td id=" " style="padding: 12px 16px">3000</td> <td style="width: 25%"> <progress value="100" max="1000"></progress><br /><span >1 TB Data used of 10TB</span > </td> </tr> </tbody> </table> <nav aria-label="..." style="/* align-items: center; */ /* justify-content: center; */margin-left:36%;" > <ul class="pagination"> <li class="page-item disabled"> <a class="page-link" href="#" tabindex="-1">Previous</a> </li> <li class="page-item"><a class="page-link" href="#">1</a></li> <li class="page-item active"> <a class="page-link" href="#" >2 <span class="sr-only">(current)</span></a > </li> <li class="page-item"><a class="page-link" href="#">3</a></li> <li class="page-item"><a class="page-link" href="#">Next</a></li> </ul> </nav> </div> </div> </div>';
