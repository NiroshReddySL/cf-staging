        ...
        if (
          ...
          if (
            ...
            if (
              ...
              var html =
                ...
                '<div id="mngCloudEmail" style="width: 28%;padding: 2.7% 1%;float:left;"><span title="titleEmail">emailId</span></div>' +
                '<div id="mngCloudType" style="width: 6%;padding: 2.7% 1%;float:left;margin-left:-75px;"><span>userType</span></div>' +
                '<div id="quickScanDiv'+AllCloudsInfo[i].cloudName+'" style="width: 17.5%;padding: 2.7% 1%;float:left;margin-left: 15px;"><button type="button" id="showSummery" cuid="' +
                AllCloudsInfo[i].userId +
                '" uid="' +
                AllCloudsInfo[i].id +
                '"style="display: inline-block;background-color: #fcfcfc;color: #1220f6;border: none;border-radius: 3px;z-index: 999999;width:91px;outline:none;margin-left:50px;" onclick="showPremigDivAlna(this)"><a href="#"><i class="lnil lnil-cloud-search" title="Quick Scan"" style="font-size:25px;color:#1220F6;font-weight:bolder;"></i></a></button></div>' +
          ...
          if (AllCloudsInfo[i].cloudName === "NETWORK_FILESHARES") {
            var html =
              ...
              '<div id="mngCloudEmail" style="width: 28%;padding: 2.7% 1%;float:left;"><span title="titleEmail">emailId</span></div>' +
              '<div id="mngCloudType" style="width: 6%;padding: 2.7% 1%;float:left;margin-left:-75px;"><span>userType</span></div>' +
              '<div id="quickScanDiv'+AllCloudsInfo[i].cloudName+'" style="width: 17.5%;padding: 2.7% 1%;float:left;margin-left: 15px;"><button type="button" id="showSummery" uid="' +
              AllCloudsInfo[i].id +
              '"style="display: inline-block;background-color: #fcfcfc;color: #1220f6;border: none;border-radius: 3px;z-index: 999999;width:91px;outline:none;margin-left:50px;" onclick="showPremigDivAlna(this)"><a href="#"><i class="lnil lnil-cloud-search" title="Quick Scan"" style="font-size:25px;color:#1220F6;font-weight:bolder;"></i></a></button> </div>' +
              '<div style="width: 8%;padding: 2.7% 1%;float:left;margin-left: 0px;display:none;"><a href="https://staging.cloudfuze.com/pages/teammigration.html?ver=1028"><button type="button" id="showSummery" style="display: inline-block;background-color: #1220f6;color: #fff;border: none;border-radius: 3px;z-index: 999999;width: 64px;">Migrate</button></a></div>' +
              '<div id="mngCloudRemove" style="margin-left:-4px;width: 2%;padding: 2.7% 2%;float:left;text-align: right;"><i cldId="' +
  ...
  if ($(e).hasClass("clearAppend")) {
	...
	var MaxFileCounts;
        ...
        for (let i = 0; i < data.length; i++) {
          var _data = data[i];
          if(!MaxUsedSpace){
              MaxUsedSpace = _data.usedSpace
          }
          if(_data.usedSpace > MaxUsedSpace){
              MaxUsedSpace = _data.usedSpace;
          $("#maxSpaceUsedUser").html(_data.emailId+'['+(MaxUsedSpace / calc).toFixed(2)+' TB]');
          }
	  if(!MaxFileCounts){
              MaxFileCounts = 0
          }
          if(_data.fileCount >= MaxFileCounts){
              MaxFileCounts = _data.fileCount;
          $("#maxfilesPresentUser").html(_data.emailId+'['+MaxFileCounts+']');
          }
	  var emailId = _data.emailId;
          var folderCount = _data.folderCount;
          TotalFolderCountForQuickScan = TotalFolderCountForQuickScan + folderCount;
          ...
          $("#totalUsedSpacePreMIg").html(usedSpaceForQuickScan.toFixed(2)+' TB');
          ...
          $("#nan").append(
            '<tr> <td style="padding: 12px 16px">' +
              ...
              emailId +
              '</td> <td style="padding: 12px 16px">'+folderCount+'</td> <td style="padding: 12px 16px">'+fileCount+'</td> <td style="width: 25%"> <progress style="width:250px;" value="' +
              usedSpace +
              '" max="' +
              totalSpace +
              '" ></progress> <br /> <span> ' +
	...
	$('[class="tableFixHeadPreMigrate"]').attr('pageNo', pageNo);
      },
      error: function (error) {
        ...
        $(e)
          .children("a")
          .css({ color: "#1220f6", "text-decoration": "underline" })
          .html('<i class="lnil lnil-cloud-search" title="Quick Scan"" style="font-size:25px;color:#1220F6;font-weight:bolder;"></i>');
        $("#manageInfoHr" + $(e).attr("uid")).css({
          width: "0%",
          "margin-top": "6%",
        });
