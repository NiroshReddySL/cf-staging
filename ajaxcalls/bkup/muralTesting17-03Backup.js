	    ...
	    var appendID = wid.replaceAll('/','_')
            $("#miroAppendWorkspaces").append(
              '<div class="row justify-content-start muralWorkspaces"><div class="col-2 my-auto text-center">' +
                '<i class="lnil lnil-chevron-down-circle" style="color: #0062ff" id="openProject" wid="' +
                _data.id +
                '"></i>' +
                ...
                "</span></div>" +
                '<div class="col-1 my-auto" id="hierachyIndicator" style="margin-left: -12px;">Workspace</div></div><hr class="hratopenWorkspace" id="hr' +
                 appendID +
          ...
          for (let i = 0; i < data.length; i++) {
            ...
            $("#appendWorkspaces").append(
              '<div class="row justify-content-start muralWorkspaces" id="workspace' +
                _data.id +
                '">' +
                '<div class="col-2 my-auto text-center"><i class="lnil lnil-chevron-down-circle" style="color: #0062ff" id="openRooms" wid="' +
                _data.id +
                '"></i></div>' +
   ...
   function getMuralRooms(wid) {
      ...
      $.ajax({
	    ...
	    appendID = appendID.replaceAll('/','_')
            $("#viewRoom" + wid).append(
              '<div class="row justify-content-start" id="roomsBody"><div class="col-10 my-auto text-center" id="openRoomsMural" rid="' +
                _data.id +
                '">' +
