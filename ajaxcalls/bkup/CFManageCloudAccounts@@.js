...
function getSortQuickScan() {
  ...
  $("#totalUsedSpacePreMIg").html(totalUsedSpace + "TB");
}
...
var csv_data = [];
var headForCsv  = ['S.No','Email Id','Total Folders','Total Files','Used Space','Scan Status'];
var csvrow = [];
...
function downloadQuickScanCSVFile(csv_data) {
			...
			temp_link.download = "QuickScan.csv";
