    ...
    success: function (data) {
      ...
      for (var i = 0; i < data.length; i++) {
        if (
          ...
          pubCount++;
          var _html =
            '<tr><td style=""><svg xmlns="http://www.w3.org/2000/svg"  style="margin-right: 2%;vertical-align: -webkit-baseline-middle;" class="icon" width="20" height="20" viewBox="0 0 1024 1024"><path fill="#4A144B" d="M880 112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32zM529 311.4c0-27.8 22.5-50.4 50.3-50.4 27.8 0 50.3 22.6 50.3 50.4v134.4c0 27.8-22.5 50.4-50.3 50.4-27.8 0-50.3-22.6-50.3-50.4V311.4zM361.5 580.2c0 27.8-22.5 50.4-50.3 50.4-13.3 0-26.1-5.3-35.6-14.8-9.4-9.5-14.7-22.3-14.7-35.6 0-27.8 22.5-50.4 50.3-50.4h50.3v50.4zm134 134.4c0 27.8-22.5 50.4-50.3 50.4-27.8 0-50.3-22.6-50.3-50.4V580.2c0-27.8 22.5-50.4 50.3-50.4 13.3 0 26.1 5.3 35.6 14.8s14.7 22.3 14.7 35.6v134.4zm-50.2-218.4h-134c-27.8 0-50.3-22.6-50.3-50.4 0-27.8 22.5-50.4 50.3-50.4h134c27.8 0 50.3 22.6 50.3 50.4-.1 27.9-22.6 50.4-50.3 50.4zm0-134.4c-13.3 0-26.1-5.3-35.6-14.8S395 324.8 395 311.4c0-27.8 22.5-50.4 50.3-50.4 27.8 0 50.3 22.6 50.3 50.4v50.4h-50.3zm134 403.2c-27.8 0-50.3-22.6-50.3-50.4v-50.4h50.3c27.8 0 50.3 22.6 50.3 50.4 0 27.8-22.5 50.4-50.3 50.4zm134-134.4h-134c-13.3 0-26.1-5.3-35.6-14.8-9.4-9.5-14.7-22.3-14.7-35.6 0-27.8 22.5-50.4 50.3-50.4h134c27.8 0 50.3 22.6 50.3 50.4 0 27.8-22.5 50.4-50.3 50.4zm0-134.4H663v-50.4c0-27.8 22.5-50.4 50.3-50.4s50.3 22.6 50.3 50.4c0 27.8-22.5 50.4-50.3 50.4z"/></svg><span style="vertical-align: -webkit-baseline-middle;">' +
          ...
          pvtCount++;
          var _html =
            '<tr><td><span>-</span></td><td style=""><img src="../img/PNG/MICROSOFT_TEAMS.png" style="height: 20px;width: 20px;vertical-align: -webkit-baseline-middle;margin-right: 2%;"><span style="vertical-align: -webkit-baseline-middle;">' +
            data[i].destCloudDetails.emailId +
            '</span></td><td><span style="margin-left: -50px;font-size: inherit;" class="closeBtn" srcid="' +
            data[i].sourceCloudDetails.id +
            '" destid="' +
...
$("#syncChannels").click(function () {
  ...
  $.ajax({
    ...
    url:
      apicallurl +
      "/messagemove/sync/slack/channel?adminCloudId=" +
      localStorage.multiUsrSrcCldId,
    headers: {
      "Content-Type": "application/json",
      Authorization: CFManageCloudAccountsAjaxCall.getAuthDetails(),
    ...
    success: function (data) {
      ...
      if (data == "No Provision User Found") {
        ...
        if (Number(pgNo) === 1) {
          ...
          if (adminId === localStorage.multiUsrSrcCldId) {
            $("#srcSlacktoSlackTable table tbody").html("");
          } else {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (adminId === localStorage.multiUsrSrcCldId) {
            $("#srcSlacktoSlackTable table tbody").append(_html);
          } else {
      ...
      if (adminId === localStorage.multiUsrSrcCldId) {
        if (data.length === 30) {
          ...
          getSlacktoSlackUsers(1, localStorage.multiUsrDstnCldId, "dstn");
        }
      } else {
        if (data.length === 30) {
          var pgno = Number(pgNo);
          pgno++;
          getSlacktoSlackUsers(pgno, localStorage.multiUsrDstnCldId, "dstn");
        }
      }

      if (adminId === localStorage.multiUsrSrcCldId) {
        $("#totalSlackSrcUsers").html(
          $("#srcSlacktoSlackTable table tbody tr").length
        );
        $("#totalSlackAuthUsers").html(pubCount);
      } else {
