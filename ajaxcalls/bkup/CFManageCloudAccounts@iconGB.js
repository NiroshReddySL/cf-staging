        ...
        if (
          ...
          if (
            ...
            var html =
              ...
              '" uid="' +
              AllCloudsInfo[i].id +
              '" style="display: inline-block;background-color: #fcfcfc;color: #1220f6;border: none;border-radius: 3px;z-index: 999999;width:91px;outline:none;margin-left:50px" onclick="showPremigDivAlna(this)"><a href="#">Scan</a></button><a href="https://staging.cloudfuze.com/pages/deepScan@2New.html?userId='+AllCloudsInfo[i].userId+'&cloudId='+AllCloudsInfo[i].id+'" target="_blank"><span style="margin-left: -29px;"> &#8599;</span></a></div>' +
            ...
            if (
              ...
              if (
                ...
                var html =
                  ...
                  '" uid="' +
                  AllCloudsInfo[i].id +
                  '" style="display: inline-block;background-color: #fcfcfc;color: #1220f6;border: none;border-radius: 3px;z-index: 999999;width:91px;outline:none;margin-left:50px;" onclick="showPremigDivAlna(this)"><a href="#"><a href="#">Scan</a></button><a href="https://staging.cloudfuze.com/pages/deepScan@2New.html?userId='+AllCloudsInfo[i].userId+'&cloudId='+AllCloudsInfo[i].id+'" target="_blank"><span style="margin-left: -29px;"> &#8599;</span></a></div>' +
                  '<div style="width: 8%;padding: 2.7% 1%;float:left;margin-left: 0px;display:none;"><a href="https://staging.cloudfuze.com/pages/teammigration.html?ver=1028"><button type="button" id="showSummery" style="display: inline-block;background-color: #1220f6;color: #fff;border: none;border-radius: 3px;z-index: 999999;width: 64px;">Migrate</button></a></div>' +
                  '<div id="mngCloudRemove" style="margin-left:-4px;width: 2%;padding: 2.7% 2%;float:left;text-align: right;"><i cldId="' +
                  AllCloudsInfo[i].id +
                  '" id="delCld"  data-action="delete" data-id="' +
              ...
              var html =
                ...
                '" uid="' +
                AllCloudsInfo[i].id +
                '"style="display: inline-block;background-color: #fcfcfc;color: #1220f6;border: none;border-radius: 3px;z-index: 999999;width:91px;outline:none;margin-left:50px;" onclick="showPremigDivAlna(this)"><a href="#"><a href="https://staging.cloudfuze.com/pages/deepScan@2New.html?userId='+AllCloudsInfo[i].userId+'&cloudId='+AllCloudsInfo[i].id+'" target="_blank"><span style="margin-left: -29px;"> &#8599;</span></a></button></div>' +
                '<div style="width: 8%;padding: 2.7% 1%;float:left;margin-left: 0px;display:none;"><a href="https://staging.cloudfuze.com/pages/teammigration.html?ver=1028"><button type="button" id="showSummery" style="display: inline-block;background-color: #1220f6;color: #fff;border: none;border-radius: 3px;z-index: 999999;width: 64px;">Migrate</button></a></div>' +
                '<div id="mngCloudRemove" style="margin-left:-4px;width: 2%;padding: 2.7% 2%;float:left;text-align: right;"><i cldId="' +
                AllCloudsInfo[i].id +
                '" id="delCld"  data-action="delete" data-id="' +
