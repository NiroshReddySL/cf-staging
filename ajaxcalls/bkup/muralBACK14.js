    ...
    success: function (data) {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        $("#miroAppendWorkspaces").append(
          '<div class="row muralWorkspaces"><div class="my-auto text-center">' +
            ...
            "</span></div>" +
            '<div class="col-1 my-auto" id="hierachyIndicator" style="position: absolute;right: 16px;top: 13px;">Team</div></div><hr class="hratopenWorkspace" id="hr' +
            appendID +
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        $("#viewRoom" + wid).append(
          '<div class="justify-content-start" id="roomsBody"><div class="text-center" style="cursor:pointer;" id="openRoomsMural" rid="' +
            _data.id +
            '">' +
            ...
            "</span></div>" +
            '<div class="col-1 my-auto" id="hierachyIndicator" style="margin-left: auto;right: 20px;">Room</div></div><div id="showFolders' +
            appendID +
            '" style="display:none;"></div>'
        );
      }
