...
function slackChannels(cloudId, type, pgNo) {
  ...
  $.ajax({
	...
	if(pageNo === 1){
	  $("#loaderText").text("Please wait while channels are being fetched...")
	  $("#CFShowLoading").show()
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.length == 0) {
        ...
        var per =
          ($("#usersTable table tbody tr").length / Number(totalMappings)) *
          100;
        $("#userPercentage").text(parseInt(per) + "%");
        $("#userProgressBar").css("width", parseInt(per) + "%");
        if (
          parseInt(Number(totalMappings / 2)) ===
      ...
      if (
        data.length === 30 &&
        localStorage.getItem("userTableStatus") === "YES"
      ) {
        pgNo = pgNo + 1;
...
$("#channelsTab").click(function () {
  ...
  localStorage.removeItem("ChannelsFetchedList");
  if ($("#usersTab").hasClass("active") || $("#authenticateUsersTabSlack").hasClass("active") || $("#authenticateUsersSrcTabSlack").hasClass("active")) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (
            ...
            var _html =
              ...
              '"><td style="width:5px;">' +
              selectMultiDelta +
              '</td><td style="display: flex;" class="chnlName"><svg xmlns="http://www.w3.org/2000/svg"  style="margin-right: 2%;" class="icon" width="20" height="20" viewBox="0 0 1024 1024"><path fill="#4A144B" d="M880 112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32zM529 311.4c0-27.8 22.5-50.4 50.3-50.4 27.8 0 50.3 22.6 50.3 50.4v134.4c0 27.8-22.5 50.4-50.3 50.4-27.8 0-50.3-22.6-50.3-50.4V311.4zM361.5 580.2c0 27.8-22.5 50.4-50.3 50.4-13.3 0-26.1-5.3-35.6-14.8-9.4-9.5-14.7-22.3-14.7-35.6 0-27.8 22.5-50.4 50.3-50.4h50.3v50.4zm134 134.4c0 27.8-22.5 50.4-50.3 50.4-27.8 0-50.3-22.6-50.3-50.4V580.2c0-27.8 22.5-50.4 50.3-50.4 13.3 0 26.1 5.3 35.6 14.8s14.7 22.3 14.7 35.6v134.4zm-50.2-218.4h-134c-27.8 0-50.3-22.6-50.3-50.4 0-27.8 22.5-50.4 50.3-50.4h134c27.8 0 50.3 22.6 50.3 50.4-.1 27.9-22.6 50.4-50.3 50.4zm0-134.4c-13.3 0-26.1-5.3-35.6-14.8S395 324.8 395 311.4c0-27.8 22.5-50.4 50.3-50.4 27.8 0 50.3 22.6 50.3 50.4v50.4h-50.3zm134 403.2c-27.8 0-50.3-22.6-50.3-50.4v-50.4h50.3c27.8 0 50.3 22.6 50.3 50.4 0 27.8-22.5 50.4-50.3 50.4zm134-134.4h-134c-13.3 0-26.1-5.3-35.6-14.8-9.4-9.5-14.7-22.3-14.7-35.6 0-27.8 22.5-50.4 50.3-50.4h134c27.8 0 50.3 22.6 50.3 50.4 0 27.8-22.5 50.4-50.3 50.4zm0-134.4H663v-50.4c0-27.8 22.5-50.4 50.3-50.4s50.3 22.6 50.3 50.4c0 27.8-22.5 50.4-50.3 50.4z"/></svg>' +
              data[i].channelName +
              "</td><td class='jobType'>" +
              jobType +
              "</td><td>" +
            ...
            var html2 =
              ...
              "</td><td>" +
              dmMultiDelta +
              '</td><td style="text-align:center;"><i class="lnil lnil-download" id="slackDMReport" style="color:#0062ff;font-size: 16px;font-weight: bold;"></i></td></tr>';
...
function csvUsersUpld(_srcMapdCldId, _dstnMapdCldId, _fileContent) {
  $.ajax({
	...
	let cldImg
	if(data[i]?.destCloudDetails?.name === "SLACK"){
	cldImg = '<svg xmlns="http://www.w3.org/2000/svg"  style="margin-right: 2%;vertical-align: -webkit-baseline-middle;" class="icon" width="20" height="20" viewBox="0 0 1024 1024"><path fill="#4A144B" d="M880 112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32zM529 311.4c0-27.8 22.5-50.4 50.3-50.4 27.8 0 50.3 22.6 50.3 50.4v134.4c0 27.8-22.5 50.4-50.3 50.4-27.8 0-50.3-22.6-50.3-50.4V311.4zM361.5 580.2c0 27.8-22.5 50.4-50.3 50.4-13.3 0-26.1-5.3-35.6-14.8-9.4-9.5-14.7-22.3-14.7-35.6 0-27.8 22.5-50.4 50.3-50.4h50.3v50.4zm134 134.4c0 27.8-22.5 50.4-50.3 50.4-27.8 0-50.3-22.6-50.3-50.4V580.2c0-27.8 22.5-50.4 50.3-50.4 13.3 0 26.1 5.3 35.6 14.8s14.7 22.3 14.7 35.6v134.4zm-50.2-218.4h-134c-27.8 0-50.3-22.6-50.3-50.4 0-27.8 22.5-50.4 50.3-50.4h134c27.8 0 50.3 22.6 50.3 50.4-.1 27.9-22.6 50.4-50.3 50.4zm0-134.4c-13.3 0-26.1-5.3-35.6-14.8S395 324.8 395 311.4c0-27.8 22.5-50.4 50.3-50.4 27.8 0 50.3 22.6 50.3 50.4v50.4h-50.3zm134 403.2c-27.8 0-50.3-22.6-50.3-50.4v-50.4h50.3c27.8 0 50.3 22.6 50.3 50.4 0 27.8-22.5 50.4-50.3 50.4zm134-134.4h-134c-13.3 0-26.1-5.3-35.6-14.8-9.4-9.5-14.7-22.3-14.7-35.6 0-27.8 22.5-50.4 50.3-50.4h134c27.8 0 50.3 22.6 50.3 50.4 0 27.8-22.5 50.4-50.3 50.4zm0-134.4H663v-50.4c0-27.8 22.5-50.4 50.3-50.4s50.3 22.6 50.3 50.4c0 27.8-22.5 50.4-50.3 50.4z"/></svg>'
	}else{
	cldImg = '<img src="../img/PNG/MICROSOFT_TEAMS.png" style="height: 20px;width: 20px;vertical-align: -webkit-baseline-middle;margin-right: 2%;">'
	}	
        ...
        if (
          ...
          pubCount++;
          var _html =
            '<tr><td style="padding-left: 4%;">'+cldImg+'<span style="vertical-align: -webkit-baseline-middle;">' +
            data[i].sourceCloudDetails.emailId +
            '</span></td><td style="">'+cldImg+
            data[i].destCloudDetails.emailId +
          ...
          pvtCount++;
          var _html =
            '<tr><td style="padding-left: 4%;"><span>-</span></td><td style="">'+cldImg+'<span style="vertical-align: -webkit-baseline-middle;">' +
            data[i].destCloudDetails.emailId +
            '</span></td><td><span style="margin-left: -50px;font-size: inherit;" class="closeBtn" srcid="' +
            data[i].sourceCloudDetails.id +
            '" destid="' +
...
$("#directMsgsTab").click(function () {
  ...
  localStorage.setItem(
    "trackDirectMessagesForSlack",
    $("#directMsgsTab").hasClass("active")
  );
...
function sendSlackEmail(clId) {
  ...
  $.ajax({
    ...
    url:
      ...
      localStorage.multiUsrSrcCldId +
      "&cloudId=" +
      cloudId +"&destAdminCloudId="+ localStorage.multiUsrDstnCldId,
    async: false,
    headers: {
      "Content-Type": "application/json",
      Authorization: CFManageCloudAccountsAjaxCall.getAuthDetails(),
...
function sendSlackBulkEmail() {
  ...
  $.ajax({
    ...
    url:
      ...
      localStorage.multiUsrSrcCldId + "&destAdminCloudId="+localStorage.multiUsrDstnCldId,
...
function startSyncChannels(isAdmin){
  $.ajax({
    ...
    url:
      ...
      localStorage.multiUsrSrcCldId+"&isAdmin="+isAdmin,
    headers: {
      "Content-Type": "application/json",
      Authorization: CFManageCloudAccountsAjaxCall.getAuthDetails(),
      "Access-Control-Allow-Methods": "GET, POST, PUT, DELETE,OPTIONS",
...
function getReplaceSpChar(text){
  if(text === "" ||text === undefined || text === null){
   ...
   var pl2 = /\"/g;
   var pl3 = /\'/g;
   let replaceText= text.replace(pl, "&lt;").replace(pl1, "&gt;").replace(pl2, "&quot;").replace(pl3, "&apos;");
   return replaceText;
  }
}
...
$(document).on("input","#channelsName",function(){
 ...
 if (spclRegax.test($(this).val()[$(this).val().length - 1])) {
   alertError("Slack won't accept withspaces and special characters except \"-\"");
        $(this).val(
          $(this)
            .val()
