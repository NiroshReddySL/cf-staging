        ...
        if (
          ...
          if (
            ...
            var html =
              ...
              '<div style="width: 10%;padding: 2.7% 1%;float:left;margin-left: 15px;"><button type="button" id="showSummery" cuid="' +
        ...
        for (let i = 0; i <= data.length; i++) {
          ...
          $("#nan").append(
            '<tr> <td style="padding: 12px 16px">' +
              ...
              emailId +
              '</td> <td style="padding: 12px 16px">'+folderCount+'</td> <td style="padding: 12px 16px">'+fileCount+'</td> <td style="width: 25%"> <progress style="width: 240px;" value="' +
              usedSpace +
              '" max="' +
              totalSpace +
              '" ></progress> <br /> <span> ' +
