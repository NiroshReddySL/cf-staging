        ...
        if (
          ...
          if (
            ...
            var html =
              ...
              '<div style="width: 10%;padding: 2.7% 1%;float:left;margin-left: 15px;"><button type="button" id="showSummery" uid="' +
              AllCloudsInfo[i].id +
              '" style="display: inline-block;background-color: #fcfcfc;color: #1220f6;border: none;border-radius: 3px;z-index: 999999;width:91px;outline:none;" onclick="showPremigDivAlna(this)"><a href="#"><u>Quick Scan</u></a></button></div>' +
              '<div style="width: 8%;padding: 2.7% 1%;float:left;margin-left: 0px;"><a href="https://staging.cloudfuze.com/pages/teammigration.html?ver=1028"><button type="button" id="showSummery" style="display: inline-block;background-color: #1220f6;color: #fff;border: none;border-radius: 3px;z-index: 999999;width: 64px;">Migrate</button></a></div>' +
...
var tableAnalysisData =
  '<div class="container-fluid"> <div id="toggleDataInModel" style=""> <div class="row" style="margin-top: 30px"> <div class="col-8 col-sm-6"> <span style=" float: left; margin-left: 65px; width: 95px; background-color: #6673ff; text-align: center; color: #fff; border-radius: 30px; font-weight: 500; margin-top: -11px; position: absolute; z-index: 1; "> <h5 style="font-size:14px;margin:4px 0px;">SUMMARY</h5> </span> <table style=" justify-content: center; text-align: center; /* width: 90%; */ border-radius: 5px; width: 100%; font-size: 12px; margin-bottom: 5%; box-shadow: 0px 0px 10px #0000001f; padding: 5%; border-radius: 12px; border-color: #0062ff; /* margin-top: 25%; */ padding: 5px; color: #8f627e; transform: translate(2.5%); /* background-color: #f6f5f8; */"> <thead style=""> <tr> <th style="text-align: center"> <i class="fa fa-user fa-user" style=" font-size: 24px; padding: 10px; padding-top: 25px; color: #ccd0ff; "></i> <div style="">Active Users</div> </th> <th style="text-align: center"> <i class="fa fa-folder fa-folder" style=" font-size: 24px; padding: 10px; padding-top: 25px; color: #ccd0ff; " ;=""></i> <div style="">Total Folders</div> </th> <th style="text-align: center"> <i class="fa fa-file" style=" font-size: 24px; padding: 10px; padding-top: 25px; color: #ccd0ff; "></i> <div style="">Total Files</div> </th> <th style="text-align: center"> <i class="fa fa-database" style=" font-size: 24px; padding: 10px; padding-top: 25px; color: #ccd0ff; "></i> <div style="">Total Size</div> </th> </tr> </thead> <tbody> <tr style=" font-size: 24px; font-weight: bolder; color: #0062ff; "> <td style="padding-bottom: 5px">5</td> <td style="padding-bottom: 5px">20</td> <td style="padding-bottom: 5px">500</td> <td style="padding-bottom: 5px">100 TB</td> </tr> </tbody> </table> </div> <div class="col-4 col-sm-6"> <table style="justify-content: center;text-align: center; width: 97%;height: 129px;border-radius: 5px;font-size: 12px;margin-bottom: 5%;box-shadow: 0px 0px 10px #0000001f;/* padding: 5%; */border-radius: 12px;border-color: #0062ff;/* margin-top: 25%; */padding: 5px;color: #8f627e;transform: translate(2.5%);/* background-color: #f6f5f8; *//* margin-left: 2.2%; */"> <tbody> <tr style="visibility: hidden"> <td style=" font-size: 15px; text-align: left; padding-left: 60px; "> Maximum file count <span style="float: right">:</span> </td> <td style=" font-weight: bold; font-size: 15px; color: #0062ff; text-align: left; padding-left: 20px; "> ben@syncorbit.com [2323] </td> </tr> <tr> <td style="font-size: 15px;text-align: left;padding-left: 32px;"> Maximum file count <span style="float: right">:</span> </td> <td style="font-weight: bold;font-size: 15px;color: #0062ff;text-align: left;padding-left: 20px;"> ben@syncorbit.com [2323] </td> </tr> <tr style="/* margin-top: 20px; */ padding: 10px"> <td style="font-size: 15px;text-align: left;padding-left: 34px;"> Maximum Used space<span style="float: right">:</span> </td> <td style=" font-weight: bold; font-size: 15px; color: #0062ff; text-align: left; padding-left: 20px; "> ben@syncorbit.com [100GB] </td> </tr> <tr style="visibility: hidden"> <td style=" font-size: 15px; text-align: left; padding-left: 60px; "> Maximum Used space<span style="float: right">:</span> </td> <td style=" font-weight: bold; font-size: 16px; color: #0062ff; text-align: left; padding-left: 20px; "> ben@syncorbit.com [100GB] </td> </tr> </tbody> </table> </div> <div class="" style="width: 105%"> <div class=""> <div class=""> <div class="tableFixHeadPreMigrate"> <table id="preMigrationAnalysisTable"> <thead> <tr> <th scope="col" style="text-align: center"> S.No </th> <th scope="col" style="text-align: center"> Email Id <span style="margin-bottom: 3px"><input type="email" placeholder="Email Id" style=" color: #777; font-weight: 400; width: 184px; height: 26px; padding: 1px 2px; " id="searchEmailInPreMig"><i class="fa fa-search" style="margin-left: -30px; color: black"></i></span> </th> <th scope="col" style="text-align: center"> Total Folders </th> <th scope="col" style="text-align: center"> Total Files<i class="fa fa-sort" type="button" style=" margin-top: 0%; font-size: 18px; padding-left: 3px; "></i> </th> <!-- <th scope="col" style="text-align: center">Used Space<i class="fa fa-sort" type="button" style="margin-top: 0%;font-size: 18px;padding-left: 3px;"></i></th> --> <!-- <th scope="col" id="AVB" style="text-align: center">User Data Space</th> --> <th scope="col" id="TotalSpace" style=" text-align: center; /* width: 66%; */ /* float: right; */ "> User Data Space <i class="lnil lnil-download" style=" /* color:#0062ff; */ margin-left: 5%; width: 15%; font-size: 16px; font-weight: bold; " title="Download Report"></i> <button type="button" id="downloadReport" style=" width: auto; /* float: right; */ display: inline-block; display: none; background-color: #1220f6; color: #fff; border: none; border-radius: 3px; /* padding: 1% 1%; */ padding-right: 14px; /* transform: translate(14px); */ "> Download &nbsp; <i class="lnil lnil-download" style=" /* color:#0062ff; */ /* margin-left: 2%; */ /* width: 21%; */ font-size: 16px; float: right; font-weight: bold; " title="Download Report"></i> </button> </th> </tr> </thead> <tbody id="tbPreMigAnal"> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 1 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> ben@filefuze.co </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 120 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 15100 </td> <td style="width: 25%"> <progress value="100" max="300"></progress><br><span>1 TB Data used of 3TB</span> </td> <!-- <td id="+eachFile.id+" style="padding: 12px 16px;">15.25 GB</td> --> <!-- <td style="padding: 12px 16px;">10.00 TB</td> <td style="padding: 12px 16px;">10.01 TB</td>--> </tr> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 2 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> leo@syncorbit.com </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 100 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 9000 </td> <td style="width: 25%"> <progress value="120" max="300"></progress><br><span>1.2 TB Data used of 3TB</span> </td> <!-- <td id="+eachFile.id+" style="padding: 12px 16px;">13.43 GB</td> --> <!-- <td style="padding: 12px 16px;">10.00 TB</td> <td style="padding: 12px 16px;">10.01 TB</td>--> </tr> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 3 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> kent@syncorbit.com </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 132 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 1014500 </td> <td style="width: 25%"> <progress value="100" max="200"></progress><br><span>1 TB Data used of 2TB</span> </td> <!-- <td id="+eachFile.id+" style="padding: 12px 16px;">158.49 GB</td> --> <!-- <td style="padding: 12px 16px;">10.00 TB</td> <td style="padding: 12px 16px;">10.01 TB</td>--> </tr> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 4 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> dan@syncorbit.com </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 1400 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 350142 </td> <td style="width: 25%"> <progress value="270" max="500"></progress><br><span>2.7 TB Data used of 5TB</span> </td> <!-- <td id="+eachFile.id+" style="padding: 12px 16px;">918.09 GB</td> --> <!-- <td style="padding: 12px 16px;">10.00 TB</td> <td style="padding: 12px 16px;">10.01 TB</td>--> </tr> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 5 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> barry@syncorbit.com </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 3 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 7 </td> <td style="width: 25%"> <progress value="50" max="200"></progress><br><span>0.5 TB Data used of 2TB</span> </td> <!-- <td id="+eachFile.id+" style="padding: 12px 16px;">6.04 MB</td> --> <!-- <td style="padding: 12px 16px;">10.00 TB</td> <td style="padding: 12px 16px;">10.01 TB</td>--> </tr> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 6 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> alex@filefuze.co </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 20 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 300 </td> <td style="width: 25%"> <progress value="220" max="300"></progress><br><span>2.2 TB Data used of 3TB</span> </td> <!-- <td id="+eachFile.id+" style="padding: 12px 16px;">2.93 GB</td> --> <!-- <td style="padding: 12px 16px;">10.00 TB</td> <td style="padding: 12px 16px;">10.01 TB</td>--> </tr> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 7 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> roy@snapbot.io </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 2 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 10 </td> <td style="width: 25%"> <progress value="400" max="3000"></progress><br><span>4 GB Data used of 3TB</span> </td> <!-- <td id="+eachFile.id+" style="padding: 12px 16px;">16.25 MB</td> --> <!-- <td style="padding: 12px 16px;">10.00 TB</td> <td style="padding: 12px 16px;">10.01 TB</td>--> </tr> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 8 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> erik@filefuze.co </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 0 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 0 </td> <td style="width: 15%"> <progress value="450" max="3000"></progress><br><span>4.3 TB Data used of 3TB</span> </td> <!-- <td id="+eachFile.id+" style="padding: 12px 16px;">0.00 Bytes</td> --> <!-- <td style="padding: 12px 16px;">10.00 TB</td> <td style="padding: 12px 16px;">10.01 TB</td>--> </tr> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 9 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> t-0.m_my@snapbot.io </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 25 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 456 </td> <td style="width: 25%"> <progress value="100" max="300"></progress><br><span>1 GB Data used of 3GB</span> </td> <!-- <td id="+eachFile.id+" style="padding: 12px 16px;">4.26 GB</td> --> <!-- <td style="padding: 12px 16px;">10.00 TB</td> <td style="padding: 12px 16px;">10.01 TB</td>--> </tr> <tr> <td id="+eachFile.id+" style="padding: 12px 16px"> 10 </td> <td id="+eachFile.id+" style="padding: 12px 16px; width: 25%"> max@snapbot.io </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 100 </td> <td id="+eachFile.id+" style="padding: 12px 16px"> 3000 </td> <td style="width: 25%"> <progress value="100" max="1000"></progress><br><span>1 TB Data used of 10TB</span> </td></tr> </tbody> </table> <nav aria-label="..." style=" /* align-items: center; */ /* justify-content: center; */ margin-left: 36%; "> <ul class="pagination"> <li class="page-item disabled"> <a class="page-link" href="#" tabindex="-1">Previous</a> </li> <li class="page-item"> <a class="page-link" href="#">1</a> </li> <li class="page-item active"> <a class="page-link" href="#">2 <span class="sr-only">(current)</span></a> </li> <li class="page-item"> <a class="page-link" href="#">3</a> </li> <li class="page-item"> <a class="page-link" href="#">Next</a> </li> </ul> </nav> </div> </div> </div> </div> </div> </div> </div>';
